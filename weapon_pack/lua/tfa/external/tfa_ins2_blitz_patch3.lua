...
if TFA.INS2 then
	if TFA.INS2.AddHoloSightType then
		...
		TFA.INS2.AddHoloSightType("sight_kobra_" .. suffix, "models/weapons/tfa_ins2/optics/okp7_dot", good and 4 or 0, good and .15 or .075, "A_RenderReticle")
...
hook.Add("TFAAttachmentsLoaded", "att_patch_" .. suffix, function()
	for k,v in pairs(Replacements) do
		if TFA.Attachments.Atts[k] then
			...
			if t.WeaponTable and t.WeaponTable.VElements then
			...
			if t.WeaponTable and t.WeaponTable.WElements then
