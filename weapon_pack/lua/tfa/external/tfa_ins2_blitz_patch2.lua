...
local Replacements = {
	["ins2_si_rds"] = {
		["name"] = "MWR RDS",
		["modelReplacement"] = {"models/weapons/tfa_ins2/upgrades/a_optic_aimpoint","models/weapons/upblitz/a_optic_mwr"},
		["modelReplacementWorld"] = {"models/weapons/tfa_ins2/upgrades/w_aimpoint","models/weapons/upblitz/w_mwr"},
		["element"] = "sight_rds",
		["icon"] = "entities/ins2_si_rds_" .. suffix .. ".png"
	},
	["ins2_si_kobra"] = {
		["name"] = "LP Kobra",
		["modelReplacement"] = {"models/weapons/tfa_ins2/upgrades/a_optic_kobra","models/weapons/upblitz/a_optic_kobra_lp"},
		["modelReplacementWorld"] = {"models/weapons/tfa_ins2/upgrades/w_kobra","models/weapons/upblitz/w_kobra_lp"},
		["element"] = "sight_kobra",
		["icon"] = "entities/ins2_si_kobra_" .. suffix .. ".png"
	},
}
...
hook.Add("TFAAttachmentsLoaded", "tfa_ins2_holosights_" .. suffix, function()
	if TFA.INS2 and TFA.INS2.AddHoloSightType then
		...
		TFA.INS2.AddHoloSightType("sight_kobra_" .. suffix, "models/weapons/tfa_ins2/optics/kobra_dot", good and 4 or 0, good and .15 or .075, "A_RenderReticle")
		-- TFA.INS2.AddHoloSightType("sight_eotech_" .. suffix, "models/weapons/tfa_ins2/optics/eotech_reticule_holo", good and 7 or 0, good and 0.28 or .14, "A_RenderReticle")
