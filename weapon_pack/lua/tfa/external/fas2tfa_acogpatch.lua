local suffix = "khrisacog"
local Replacements = {
	["ins2_si_c79"] = {
		["name"] = "Thanez ACOG",
		["modelReplacement"] = {"models/weapons/tfa_ins2/upgrades/a_optic_elcan","models/weapons/fas2vm/acog/a_optic_elcan"},
		["modelReplacementWorld"] = {"models/weapons/tfa_ins2/upgrades/w_elcan","models/weapons/fas2vm/acog/w_elcan"},
		["icon"] = "entities/thanez4xacog.png",
		["element"] = "scope_c79"
	},
...
if TFA.INS2 then
	if TFA.INS2.AddHoloSightType then
		...
		TFA.INS2.AddHoloSightType("sight_rds_" .. suffix, "models/weapons/fas2vm/pkas/aimpoint_pkasreticule", good and 5 or 0, good and .05 or .025, "A_RenderReticle")
