local suffix = "YanBSP_1"
local Replacements = {

	["ins2_si_eotech"] = {
		["name"] = "EOTech 552",
		["modelReplacement"] = {"models/weapons/tfa_ins2/upgrades/a_optic_eotech","models/weapons/upgrades_yans_bsp/a_optic_eotech_552"},
	...
	["ins2_si_rds"] = {
		["name"] = "Micro T1",
		["modelReplacement"] = {"models/weapons/tfa_ins2/upgrades/a_optic_aimpoint","models/weapons/upgrades_yans_bsp/a_optic_micro_t1"},
		["modelReplacementWorld"] = {"models/weapons/tfa_ins2/upgrades/w_aimpoint","models/weapons/upgrades_yans_bsp/w_micro_t1"},
		["element"] = "sight_rds",
	...
	["ins2_si_kobra"] = {
		["name"] = "Reflex Kobra",
		["modelReplacement"] = {"models/weapons/tfa_ins2/upgrades/a_optic_kobra","models/weapons/upgrades_yans_bsp/a_optic_fc3_reflex_sight"},
		["modelReplacementWorld"] = {"models/weapons/tfa_ins2/upgrades/w_kobra","models/weapons/upgrades_yans_bsp/w_fc3_reflex_sight"},
		["element"] = "sight_kobra",
...
hook.Add("TFAAttachmentsLoaded", "tfa_ins2_holosights_" .. suffix, function()
	if TFA.INS2 and TFA.INS2.AddHoloSightType then
		...
		TFA.INS2.AddHoloSightType("sight_kobra_" .. suffix, "models/weapons/optics/kobra_amber_dot_reticule", good and 4 or 0, good and .19 or .075, "A_RenderReticle")
		TFA.INS2.AddHoloSightType("sight_eotech_" .. suffix, "models/weapons/optics/eotech_3_dots_reticule", good and 7 or 0, good and 0.42 or .14, "A_RenderReticle")
		TFA.INS2.AddHoloSightType("sight_rds_" .. suffix, "models/weapons/optics/aimpoint_holo_red_dot_reticule", good and 5 or 0, good and .50 or .025, "A_RenderReticle")
	end
end)
