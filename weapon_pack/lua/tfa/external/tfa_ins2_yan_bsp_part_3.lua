local suffix = "YanBSP_3"
local Replacements = {

	["ins2_si_eotech"] = {
		["name"] = "EOTech 556",
		["modelReplacement"] = {"models/weapons/tfa_ins2/upgrades/a_optic_eotech","models/weapons/upgrades_yans_bsp/a_optic_eotech_556"},
		["modelReplacementWorld"] = {"models/weapons/tfa_ins2/upgrades/w_eotech","models/weapons/upgrades_yans_bsp/w_eotech_552"},
	...
	["ins2_si_rds"] = {
		["name"] = "Trijicon MRO",
		["modelReplacement"] = {"models/weapons/tfa_ins2/upgrades/a_optic_aimpoint","models/weapons/upgrades_yans_bsp/a_optic_trijicon_mro"},
		["modelReplacementWorld"] = {"models/weapons/tfa_ins2/upgrades/w_aimpoint","models/weapons/upgrades_yans_bsp/w_trijicon_mro"},
		["element"] = "sight_rds",
	...
	["ins2_si_kobra"] = {
		["name"] = "Holosun 510C",
		["modelReplacement"] = {"models/weapons/tfa_ins2/upgrades/a_optic_kobra","models/weapons/upgrades_yans_bsp/a_optic_mw2019_operator_reflex"},
		["modelReplacementWorld"] = {"models/weapons/tfa_ins2/upgrades/w_kobra","models/weapons/upgrades_yans_bsp/w_operator_reflex_sight"},
		["element"] = "sight_kobra",
...
hook.Add("TFAAttachmentsLoaded", "tfa_ins2_holosights_" .. suffix, function()
	if TFA.INS2 and TFA.INS2.AddHoloSightType then
		...
		TFA.INS2.AddHoloSightType("sight_kobra_" .. suffix, "models/weapons/optics/aimpoint_holo_red_dot_reticule", good and 4 or 0, good and .40 or .075, "A_RenderReticle")
		TFA.INS2.AddHoloSightType("sight_eotech_" .. suffix, "models/weapons/optics/eotech_1_dot_reticule", good and 7 or 0, good and 0.35 or .14, "A_RenderReticle")
		TFA.INS2.AddHoloSightType("sight_rds_" .. suffix, "models/weapons/optics/aimpoint_holo_red_dot_reticule", good and 5 or 0, good and 0.32 or .14, "A_RenderReticle")
    end
end)
