local path = "/weapons/scar_ssr/"
local pref = "TFA_INS2.SCAR_SSR"
...
TFA.AddWeaponSound(pref .. ".Bolttake", path .. "bolttake.wav")
TFA.AddWeaponSound(pref .. ".Boltrelease", path .. "boltrelease.wav")
TFA.AddWeaponSound(pref .. ".Boltslap", path .. "boltback.wav")
