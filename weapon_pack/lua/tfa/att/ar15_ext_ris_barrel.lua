...
ATTACHMENT.Description = { TFA.AttachmentColors["+"], "Activates Laser Sight and GL", "10% Increased Range", TFA.AttachmentColors["-"], "Significantly Lower Hipfire Spread", "5% slower movespeed" }
