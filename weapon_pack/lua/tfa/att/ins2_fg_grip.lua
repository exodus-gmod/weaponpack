...
ATTACHMENT.Name = CLIENT and "#insurgency_weapon_upgrade_foregrip" or "Foregrip"
ATTACHMENT.Description = {
	"#insurgency_weapon_upgrade_foregrip_desc",
	TFA.AttachmentColors["+"], "20% less vertical recoil", "20% less horizontal recoil",
	TFA.AttachmentColors["-"], "Significantly slower ADS speed", "15% wider spread", "5% slower movespeed"
}
ATTACHMENT.Icon = "entities/ins2_att_grp.png"
