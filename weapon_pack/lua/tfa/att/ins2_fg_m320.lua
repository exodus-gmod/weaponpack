...
ATTACHMENT.Name = "M320"
--ATTACHMENT.ID = "base" -- normally this is just your filename
ATTACHMENT.Description = { TFA.AttachmentColors["+"], "E+Click to select grenade launcher", "Cooler Animations Than M203", TFA.AttachmentColors["-"], "5% slower movespeed", TFA.AttachmentColors["="], "I know the thumbnail is from MW3"}
ATTACHMENT.Icon = "entities/M320_MW3.png" --Revers to label, please give it an icon though!  This should be the path to a png, like "entities/tfa_ammo_match.png"
...
ATTACHMENT.WeaponTable = {
	...
	["Animations"] = {
		...
		["shoot1_empty"] = function(wep,val)
			...
			val["type"] = TFA.Enum.ANIMATION_SEQ
			if wep:GLDeployed() then
			val["value"] = "glsetup_holster"
			else
				val["value"] = "gl_holster"
			end
			return val, true, true
		end,
