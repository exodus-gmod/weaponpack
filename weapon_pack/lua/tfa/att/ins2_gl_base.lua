...
ATTACHMENT.Name = "INS2 GL Base"
ATTACHMENT.Description = {
	TFA.AttachmentColors["+"], "E+Click to select grenade launcher",
	TFA.AttachmentColors["-"], "5% slower movespeed"
}

ATTACHMENT.Icon = "entities/ins2_att_m203.png"
...
ATTACHMENT.WeaponTable = {
	...
	Primary = {
		...
		MovementSpeed = function(wep,stat) return stat * 0.95 end,
		IronSightsMovementSpeed = function(wep,stat) return stat * 0.95 end,
