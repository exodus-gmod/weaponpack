...
SWEP.Purpose				= "A modern .45 ACP pistol. Built for competition shooting." --Purpose Tooltip
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_INS2.USP_M.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_INS2.USP_M.2") -- This is the sound of the weapon, when silenced.
...
--Recoil Related
SWEP.Primary.KickUp = 0.236 -- This is the maximum upwards recoil (rise)
...
SWEP.VMPos = Vector(-0.25, -0.1, -0.75)
...
SWEP.HoldType = "pistol" -- This is how others view yozccu carrying the weapon. Options include:
...
SWEP.IronSightsPos = Vector(-1.525, 1, 0.275)
SWEP.IronSightsAng = Vector(-0.223, 0.036, 0)

SWEP.IronSightsPos_RMR = Vector( -1.57, 0.28, -0.125)
...
SWEP.ViewModelBoneMods = {
	["A_Underbarrel"] = { scale = Vector(1, 1, 1), pos = Vector(0, -1.2, 0.36), angle = Angle(0, 0, 0) }
}
...
SWEP.Attachments = {
	...
	[4] = { offset = { 0, 0 }, atts = { "am_match", "am_magnum", "am_gib" }, order = 5 },
	[5] = { offset = { 0, 0 }, atts = { "ins2_ub_laser", "ins2_ub_flashlight1" }, order = 4 },
}
SWEP.AttachmentDependencies = {}
SWEP.AttachmentExclusions = {}

SWEP.VElements = {
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/usp_match/a_suppressor_pistol.mdl", bone = "A_Suppressor", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
	["laser"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_laser_cz75a.mdl", bone = "A_Underbarrel", rel = "", pos = Vector(-1.5, 0, -0.1), angle = Angle(0, 0, 0), size = Vector(0.7, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
	["laser_beam"] = { type = "Model", model = "models/tfa/lbeam.mdl", bone = "LaserPistol", rel = "laser", pos = Vector(0, -0.2, -0.4), angle = Angle(0, 0, 0), size = Vector(2, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false },
	["flashlight"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_laser_cz75a.mdl", bone = "A_Underbarrel", rel = "", pos = Vector(-1.5, 0, -0.1), angle = Angle(0, 0, 0), size = Vector(0.7, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
	["sight_rmr"] = { type = "Model", model = "models/weapons/tfa_eft/upgrades/v_rmr.mdl", bone = "Slide", rel = "", pos = Vector(-0.01835, -2, 0.5), angle = Angle(0, 180, 0), size = Vector(0.85, 0.95, 0.95), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = false, active = false, bodygroup = {} },
				["sight_rmr_lens"] = (TFA.EFTC and TFA.EFTC.GetHoloSightReticle) and TFA.EFTC.GetHoloSightReticle("sight_rmr") or nil,
}

SWEP.WElements = {
	["ref"] = { type = "Model", model = "models/weapons/tfa_ins2/w_usp_match.mdl", bone = "oof", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/usp_match/w_suppressor_pistol.mdl", bone = "ATTACH_Muzzle", rel = "ref", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
