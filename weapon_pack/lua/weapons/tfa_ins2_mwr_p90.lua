...
SWEP.Purpose			= "A specialist SMG chambered in 5.7 rounds. Comes with a high capacity, perfect for suppression." --Purpose Tooltip
...
SWEP.Attachments = {
	...
	[7] = { atts = { "ins2_si_kobra", "ins2_si_eotech", "ins2_si_rds" }, order = 1 },
