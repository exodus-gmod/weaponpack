...
SWEP.Purpose				= "A classic. Reliable, and effective. Best used for close quarters combat." --Purpose Tooltip
...
SWEP.Type = "German 9x19mm Automatic Sub Machine Gun"
...
SWEP.Primary.KickHorizontal = 0.080 -- This is the maximum sideways recoil (no real term)
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2/v_mp5.mdl" --Viewmodel path
SWEP.ViewModelFOV			= 70		-- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip			= false		-- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands = true --Use gmod c_arms system.
SWEP.VMPos = Vector(0.2,1.2,0.1) --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2/w_mp5.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(3, -1, 1) --Change this, using SWEP Creation Kit preferably
...
SWEP.IronSightsPos = Vector(-2.3, -1.25, 0.49)
SWEP.IronSightsAng = Vector(0.55, 0, 0)

SWEP.IronSightsPos_C79     = Vector(-2.323, -1.5, -0.39)
SWEP.IronSightsAng_C79     = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_C79 = 65
SWEP.RTScopeFOV_C79        = 50

SWEP.IronSightsPos_RDS = Vector(-2.34, -0.293, -0.35)
SWEP.IronSightsAng_RDS = Vector(0, -0.15, 0)

SWEP.IronSightsPos_2XRDS = Vector(-2.322, -2, -0.41)
SWEP.IronSightsAng_2XRDS = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_2XRDS = 65
SWEP.RTScopeFOV_2XRDS        = 30

SWEP.IronSightsPos_EOTech = Vector(-2.34, -0.193, -0.22)
SWEP.IronSightsAng_EOTech = Vector(0, -0.15, 0)

SWEP.IronSightsPos_Kobra = Vector(-2.343, -0.193, -0.11)
SWEP.IronSightsAng_Kobra = Vector(0, -0.15, 0)

SWEP.IronSightsPos_RMRCanted = Vector(-4.55, -3., 1.42)
SWEP.IronSightsAng_RMRCanted = Vector(0, 0, -34)

SWEP.IronSightsPos_NVPoint = Vector(-5., 4, 1.5)
...
SWEP.ViewModelBoneMods = {
	["A_Optic"] = { scale = Vector(0.86, 0.86, 0.86), pos = Vector(0, -0.5, 0), angle = Angle(0, 0, 0) },
	["A_Modkit"] = { scale = Vector(0.88, 0.88, 0.88), pos = Vector(0, 3, -0.65), angle = Angle(0, 0, 0) },
	["A_Suppressor"] = { scale = Vector(1, 0.9, 1), pos = Vector(0, -0.2, 0), angle = Angle(0, 0, 0) },
	["A_LaserFlashlight"] = { scale = Vector(0.9, 0.9, 0.9), pos = Vector(0.2, -2, -0.08), angle = Angle(0, 0, 90) },
}

SWEP.WorldModelBoneMods = {
	["ATTACH_Muzzle"] = { scale = Vector(1, 1, 0.9), pos = Vector(0.43, 1.6, 0), angle = Angle(0, 0, 0) },
	["ATTACH_Laser"] = { scale = Vector(1, 1, 1), pos = Vector(0, -2.7, 0.24), angle = Angle(0, 0, 0) },
}

SWEP.VElements = {
["sight_eotech"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_eotech.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0., 0), angle = Angle(90, 90, 0), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
	["sight_eotech_lens"] = (TFA.INS2 and TFA.INS2.GetHoloSightReticle) and TFA.INS2.GetHoloSightReticle("sight_eotech") or nil,
	["sight_rds"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_aimpoint.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0.03, 0.0), angle = Angle(90, 90, 0), size = Vector(0.86, 0.86, 0.86), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
	["sight_rds_lens"] = (TFA.INS2 and TFA.INS2.GetHoloSightReticle) and TFA.INS2.GetHoloSightReticle("sight_rds") or nil,
	["scope_2xrds"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_aimp2x.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0.03, 0), angle = Angle(90, 90, 0), size = Vector(0.9, 0.9, 0.9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
	["scope_c79"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_elcan.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0.02, -0.4), angle = Angle(90, 90, 0), size = Vector(0.60, 0.70, 0.70), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
	["sight_kobra"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_kobra.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(90, 90, 0), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
	["sight_kobra_lens"] = (TFA.INS2 and TFA.INS2.GetHoloSightReticle) and TFA.INS2.GetHoloSightReticle("sight_kobra") or nil,
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_suppressor_pistol.mdl", bone = "A_Suppressor", rel = "", pos = Vector(0, -1.55, 25), angle = Angle(90, 0, 0), size = Vector(1, 0.9, 0.9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} , bonemerge = true, active = false },
	["laser"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_laser_band.mdl", bone = "A_LaserFlashlight", rel = "", pos = Vector(0, 4.5, 0), angle = Angle(0, 90, -90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
	["laser_beam"] = { type = "Model", model = "models/tfa/lbeam.mdl", bone = "A_Beam", rel = "laser", pos = Vector(0,0,0.2), angle = Angle(0, 0, 0), size = Vector(2, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
	["rail_sights"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_modkit_g3a3.mdl", bone = "A_Modkit", rel = "", pos = Vector(0, -0.245, -5), angle = Angle(0, 0, 0), size = Vector(55555, 55555, 55555), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false},
}
...
["ref"] = { type = "Model", model = SWEP.WorldModel, bone = "oof", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
	["sight_eotech"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_eotech.mdl", bone = "ATTACH_ModKit", rel = "ref", pos = Vector(8.1, 1, 12.5), angle = Angle(-5.7, 0, 180), size = Vector(0.845, 0.845, 0.845), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
	["sight_rds"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_aimpoint.mdl", bone = "ATTACH_ModKit", rel = "ref", pos = Vector(-48, 1.079, 15.4), angle = Angle(-5.7, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = true, bodygroup = {}, active = false },
	["scope_2xrds"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_magaim.mdl", bone = "ATTACH_ModKit", rel = "ref", pos = Vector(-34.5, 1.079, 14), angle = Angle(-5.7, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = true, bodygroup = {}, active = false },
	["scope_c79"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_elcan.mdl", bone = "ATTACH_ModKit", rel = "ref", pos = Vector(-40.2, 1.079, 10.8), angle = Angle(-5.7, 0, 180), size = Vector(0.7, 0.7, 0.7), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
    ...
    ["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_sil_pistol.mdl", bone = "ATTACH_Muzzle", rel = "ref", pos = Vector(-13, 0, 15.52), angle = Angle(0, 0, 0), size = Vector(1, 0.9, 0.9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
...
function SWEP:Think2(...)
    ...
    if self.Owner:KeyPressed(IN_ZOOM) and self:GetIronSights() then 
        if self.CurrentSightState == 1 then 
			...
			self.IronSightsPos = Vector(-2.3, -1.25, 0.49)
			self.IronSightsAng = Vector(0.55, 0, 0)
			self.IronSightsPos_Kobra = Vector(-2.343, -0.193, -0.11)
			self.IronSightsAng_Kobra = Vector(0, -0.15, 0)
			self.IronSightsPos_EOTech = Vector(-2.34, -0.193, -0.22)
			self.IronSightsAng_EOTech = Vector(0, -0.15, 0)
			self.IronSightsPos_RDS = Vector(-2.34, -0.293, -0.35)
			self.IronSightsAng_RDS = Vector(0, -0.15, 0)
			self.IronSightsPos_2XRDS = Vector(-2.322, -2, -0.41)
			self.IronSightsAng_2XRDS = Vector(0, 0, 0)
			self.IronSightsPos_C79 = Vector(-2.323, -1.5, -0.39)
