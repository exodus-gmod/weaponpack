...
SWEP.Purpose				= "A highly specialized integrally suppressed assault rifle using 20 rounds of 9x39." --Purpose Tooltip
...
SWEP.Secondary.IronFOV_vss_pso = 65
...
SWEP.Attachments = {
	...
	[2] = { atts = { "ins2_br_heavy", "ins2_br_light" }, order = 2 },
	[3] = { atts = { "ins2_ub_laser", "ins2_ub_flashlight" }, order = 4 },
	[4] = { atts = { "inss_fg_grip" }, order = 3 },
	[7] = { atts = { "am_match", "am_magnum", "am_gib" }, order = 5 },
}
