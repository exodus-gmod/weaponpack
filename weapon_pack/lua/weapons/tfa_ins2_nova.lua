...
SWEP.Purpose				= "A heavy pump action shotgun. Has high stopping power, but fires slower." --Purpose Tooltip
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_INS2.NOVA.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_INS2.NOVA.2") -- This is the sound of the weapon, when silenced.
...
SWEP.Primary.RPM_Displayed = 200 -- This is in Rounds Per Minute / RPM
...
SWEP.Primary.MaxFalloff         = 5 -- Maximal amount of damage to be lost
--Penetration Related
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2/c_nova.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2/w_nova.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-2.05, -2, 0.85)
SWEP.IronSightsAng = Vector(0, 0, 0)

SWEP.IronSightsPos_Kobra = Vector(-2.048, -4, -0.151)
SWEP.IronSightsAng_Kobra = Vector(0, 0, 0)

SWEP.IronSightsPos_EOTech = Vector(-2.048, -4, -0.39)
SWEP.IronSightsAng_EOTech = Vector(0, 0, 0)

SWEP.IronSightsPos_RDS = Vector(-2.048, -4, -0.391)
SWEP.IronSightsAng_RDS = Vector(0, 0, 0)

SWEP.IronSightsPos_2XRDS = Vector(-2.045, -2.5, -0.395)
SWEP.IronSightsAng_2XRDS = Vector(0, 0, 0)
SWEP.RTScopeFOV_2XRDS        = 30

SWEP.IronSightsPos_C79 = Vector(-2.048, -3, -0.523)
SWEP.IronSightsAng_C79 = Vector(0, 0, 0)
SWEP.RTScopeFOV_C79        = 50

SWEP.IronSightsPos_PO4X = Vector(-1.983, -4, -0.058)
...
SWEP.EventTable = {
	...
	[ACT_VM_PULLBACK] = {
		{ ["time"] = 11 / 35, ["type"] = "lua", ["value"] = function(wep,vm)
			if wep and wep.EventShell then
				wep:EventShell()
			end
		end, ["client"] = true, ["server"] = true }
...
SWEP.ViewModelBoneMods = {
	["A_Suppressor"] = { scale = Vector(0.75, 0.75, 0.75), pos = Vector(-0.02, 0, 0.085), angle = Angle(0, 0, 0) },
	["A_Foregrip"] = { scale = Vector(0.55, 0.55, 0.55), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
}

SWEP.VElements = {
	["sights_folded"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_standard_nova.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = true },
	...
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_suppressor_12ga.mdl", bone = "A_Suppressor", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
...
SWEP.WElements = {
	...
	["flashlight"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_laser_sec.mdl", bone = "", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 180), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },

}
SWEP.Attachments = {
	[1] = { offset = { 0, 0 }, atts = { "ins2_br_supp", "r6s_muzzle_2", "r6s_flashhider_2" }, order = 2 },
	[8] = { offset = { 0, 0 }, atts = { "ins2_si_kobra", "ins2_si_eotech", "ins2_si_rds", "ins2_si_2xrds" }, order = 1 },
	[2] = { offset = { 0, 0 }, atts = { "ins2_br_heavy", "ins2_br_light"  }, order = 3 },
	[9] = { offset = { 0, 0 }, atts = { "ins2_fg_grip" }, order = 4 },
...
SWEP.ShellModel = "models/weapons/tfa_ins2/w_nova_shell.mdl"
SWEP.ShellScale = 1.8
SWEP.ShellYaw = 90
