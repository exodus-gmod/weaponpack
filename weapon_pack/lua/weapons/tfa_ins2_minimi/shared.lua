...
SWEP.Category				= "EXR - LMGs" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
...
SWEP.Purpose				= "A light, modular LMG built for suppression and long duration fire." --Purpose Tooltip
...
SWEP.IronSightsPos_Kobra = Vector(-2.684, -3, 0.227)
SWEP.IronSightsAng_Kobra = Vector(0, 0, 0)

SWEP.IronSightsPos_EOTech = Vector(-2.684, -2.113, 0.15)
SWEP.IronSightsAng_EOTech = Vector(0, 0, 0)

SWEP.IronSightsPos_RDS = Vector(-2.684, -2.1, 0.15)
SWEP.IronSightsAng_RDS = Vector(0, 0, 0)

SWEP.IronSightsPos_2XRDS = Vector(-2.681, -2.5, 0.145)
SWEP.IronSightsAng_2XRDS = Vector(0, 0, 0)
SWEP.RTScopeFOV_2XRDS        = 30

SWEP.IronSightsPos_C79 = Vector(-2.686, -3, -0.235)
SWEP.IronSightsAng_C79 = Vector(0, 0, 0)
SWEP.RTScopeFOV_C79        = 50

SWEP.IronSightsPos_PO4X = Vector(-2.615,-4, 0.255)
...
SWEP.ScopeDistanceMin_2XRDS = 8.75
