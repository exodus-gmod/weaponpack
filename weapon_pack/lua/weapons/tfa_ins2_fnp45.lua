...
SWEP.Primary.Damage                = ( TFA and TFA.Yankys_Custom_Weapon_Pack ) and 62 * TFA.Yankys_Custom_Weapon_Pack.DamageMultiplier or 27
...
SWEP.Attachments = {
	[1] = { atts = { "r6s_muzzle_2", "r6s_flashhider_2", "ins2_br_supp", } },
	[2] = { offset = { 0, 0 }, atts = { "ins2_br_heavy" } },
	[3] = { atts = { "ins2_ub_laser", "ins2_laser_flashlight_x400", "ins2_ub_flashlight1", "ins2_eft_lastac2" } },
