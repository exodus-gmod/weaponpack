...
SWEP.Manufacturer = "H&K" --Gun Manufactrer (e.g. Hoeckler and Koch )
SWEP.Author				= "shrimp - Edit by Lucho" --Author Tooltip
SWEP.Purpose = "A polymer assault rifle. Lightweight and reliable. Chambered in 5.56 NATO."
...
SWEP.PrintName				= "G36K"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_INSS_G36K.Fp") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_INSS_G36K.Suppressed_Fp") -- This is the sound of the weapon, when silenced.
...
--Recoil Related
SWEP.Primary.KickUp = 0.138 -- This is the maximum upwards recoil (rise)
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/v_g36k.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/w_g36k.mdl" -- Weapon world model path
...
function SWEP:Think2(...)
    ...
    if self.Owner:KeyPressed(IN_ZOOM) and self:GetIronSights() then 
        if self.CurrentSightState == 1 then 
			...
			self.IronSightsPos = Vector(-3.225, -2, 1.03)
			self.IronSightsAng = Vector(0.25, 0, 0)
			self.IronSightsPos_Kobra = Vector(-3.238, -3, 0.48)
			self.IronSightsAng_Kobra = Vector(0, 0, 0)
			self.IronSightsPos_EOTech = Vector(-3.25, -3, 0.40)
			self.IronSightsAng_EOTech = Vector(0.25, 0, 0)
			self.IronSightsPos_RDS = Vector(-3.238, -3, 0.282)
			self.IronSightsAng_RDS = Vector(0, 0, 0)
			self.IronSightsPos_2XRDS = Vector(-3.236, -6, 0.46)
			self.IronSightsAng_2XRDS = Vector(0, 0, 0)
			self.IronSightsPos_C79 = Vector(-3.236, -5, 0.19)
...
SWEP.ViewModelBoneMods = {
	["A_Foregrip"] = { scale = Vector(0.4, 0.5, 0.4), pos = Vector(0, 0, 0), angle = Angle(0,0,0) },
...
SWEP.VElements = {
	...
	["scope_qts11"] = { type = "Model", model = "models/weapons/insurgency_sandstorm/upgrades/sandstorm_optic_po4x24.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
	...
	["laser"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_laser_rail.mdl", bone = "A_LaserFlashlight", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0, 0, 0), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
	["flashlight"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_flashlight_rail.mdl", bone = "A_LaserFlashlight", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0, 0, 0), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
	["sight_rmr_canted"] = { type = "Model", model = "models/weapons/tfa_eft/upgrades/sights/reflex/v_canted_rmr.mdl", bone = "A_Optic", rel = "", pos = Vector(0.05, 0, -0.3), angle = Angle(90, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
...
SWEP.WElements = {
	...
	["scope_po4x"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_po.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_sil_sec1.mdl", bone = "ATTACH_Muzzle", rel = "", pos = Vector(-31.2, 0, 6.2), angle = Angle(0, 0, 0), size = Vector(0.7, 0.7, 0.7), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} , bonemerge = false, active = false },
	["foregrip"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_foregrip_sec2.mdl", bone = "ATTACH_Foregrip", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, -90), size = Vector(0.6, 0.6, 0.6), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false},
...
SWEP.Attachments = {	
	...
	[4] = { offset = { 0, 0 }, atts = { "am_match", "am_magnum", "am_gib" }, order = 6 },
	[5] = { offset = { 0, 0 }, atts = { "ins2_fg_grip" }, order = 4 },
	[6] = { offset = { 0, 0 }, atts = { "ins2_ub_laser", "ins2_ub_flashlight2" }, order = 5 },
}
