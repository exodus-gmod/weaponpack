...
SWEP.Primary.KickHorizontal      = 0.164                        -- This is the maximum sideways recoil (no real term)
...
SWEP.IronSightsPos_Kobra  = Vector(-2.475, 0, -0.48)
SWEP.IronSightsAng_Kobra  = Vector(0, 0.02, 0)

SWEP.IronSightsPos_RDS    = Vector(-2.465, -0.25, -0.65)
SWEP.IronSightsAng_RDS    = Vector(0, 0.05, 0)

SWEP.IronSightsPos_EOTech = Vector(-2.465, 0, -0.65)
SWEP.IronSightsAng_EOTech = Vector(0, 0.065, 0)

SWEP.IronSightsPos_2XRDS  = Vector(-2.472, -1.25, -0.65)
...
SWEP.Attachments = {
	...
	[9] = { atts = { "am_match", "am_magnum", "am_gib" } },
}
...
SWEP.ViewModelBoneMods = {
	...
	["A_Optic"] = { scale = Vector(0.8, 0.8, 0.8), pos = Vector(0, 0, 0.335), angle = Angle(0, 0, 0) },
...
SWEP.WorldModelBoneMods = {
	...
	["ATTACH_Muzzle"] = { scale = Vector(0.9, 0.75, 0.75), pos = Vector(-2., 0, 0), angle = Angle(0, 0, 0) },
}
...
SWEP.VElements = {
	...
	["scope_po4x"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_po4x24_m.mdl", bone = "A_Optic", rel = "ref", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },

	["scope_mx4"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_m40_l.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, -0.35), angle = Angle(90, 90, 0), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
