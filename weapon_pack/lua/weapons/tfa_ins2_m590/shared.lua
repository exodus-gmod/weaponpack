...
SWEP.Manufacturer = "O.F. Mossberg & Sons" --Gun Manufactrer (e.g. Hoeckler and Koch )
...
SWEP.Purpose				= "A fast firing pump action tube fed shotgun. Best used in close encounters." --Purpose Tooltip
...
SWEP.Type = "American 12 Gauge Pump-Action Shotgun"
--[[WEAPON HANDLING]]--
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2/v_m590.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2/w_m590.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(3, -6, -5) --Change this, using SWEP Creation Kit preferably
...
SWEP.IronSightsPos = Vector(-2.195, -1.552, 0.88)
SWEP.IronSightsAng = Vector(0.1, 0.02, 0)

SWEP.IronSightsPos_Kobra = Vector(-2.205, -1.552, 0)
SWEP.IronSightsAng_Kobra = Vector(0, 0, 0)

SWEP.IronSightsPos_EOTech = Vector(-2.205, -1.552, -0.21)
SWEP.IronSightsAng_EOTech = Vector(0, 0, 0)

SWEP.IronSightsPos_RDS = Vector(-2.205, -1.852, -0.205)
SWEP.IronSightsAng_RDS = Vector(0, 0, 0)

SWEP.IronSightsPos_2XRDS = Vector(-2.2025, -2.5, -0.207)
SWEP.IronSightsAng_2XRDS = Vector(0.0, -0.0, 0)
SWEP.RTScopeFOV_2XRDS        = 30

SWEP.IronSightsPos_C79 = Vector(-2.204, -3.5, -0.228)
SWEP.IronSightsAng_C79 = Vector(0.0, -0.0, 0)
SWEP.RTScopeFOV_C79        = 50

SWEP.IronSightsPos_PO4X = Vector(-2.1545, -4.5, 0.225)
SWEP.IronSightsAng_PO4X = Vector(0.0, -0.0, 0)
...
SWEP.SequenceLengthOverride = {
	[ACT_SHOTGUN_PUMP] = 15 / 30,
	[ACT_VM_PULLBACK] = 15 / 30,
	[ACT_VM_PULLBACK_LOW] = 15 / 30,
	[ACT_VM_PULLBACK_HIGH] = 15 / 30,
	[ACT_VM_DRYFIRE] = 0.5
...
SWEP.ViewModelBoneMods = {
	...
	["A_Optic"] = { scale = Vector(0.88, 0.88, 0.88), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["A_Modkit"] = { scale = Vector(0.88, 0.88, 0.88), pos = Vector(0.01, 0, 0.23), angle = Angle(0, 0, 0) }
}

SWEP.WorldModelBoneMods = {
	["ATTACH_ModKit"] = { scale = Vector(0.7, 0.7, 0.7), pos = Vector(0, -1, 0.17), angle = Angle(0, 0, 0) },
}


SWEP.VElements = {
	["sights_folded"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_standard_m590.mdl", bone = "A_Modkit", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = true},
	...
	["scope_c79"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_elcan.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(90, 90, 0), size = Vector(0.7, 0.7, 0.7), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
	["scope_po4x"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_po4x24.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(90, 90, 0), size = Vector(0.65, 0.65, 0.65), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_suppressor_12ga.mdl", bone = "A_Suppressor", rel = "", pos = Vector(-15, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} , bonemerge = true, active = false },
	["foregrip"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_foregrip_sec.mdl", bone = "A_Foregrip", rel = "", pos = Vector(0, -0.1, 0.4), angle = Angle(0, 90, 0), size = Vector(0.4, 0.4, 0.4), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
	["rail_sights"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_modkit_04.mdl", bone = "A_Optic", rel = "", pos = Vector(0, -0.245, -5), angle = Angle(0, 0, 0), size = Vector(55555, 55555, 55555), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false},
	...
	["flashlight"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_flashlight_band.mdl", bone = "laser", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 180), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
...
SWEP.WElements = {
	...
	["rail_sights"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_modkit_4.mdl", bone = "ATTACH_ModKit", rel = "ref", pos = Vector(0, 1, -3.6), angle = Angle(-5.7, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
	["flashlight"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_laser_sec.mdl", bone = "ATTACH_Laser", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 180), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
...
SWEP.Attachments = {
	...
	[5] = { offset = { 0, 0 }, atts = { "ins2_ub_laser", "ins2_ub_flashlight1" }, order = 5 }
