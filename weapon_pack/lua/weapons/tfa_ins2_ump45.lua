...
SWEP.Purpose				= "A slow firing, cheap, and reliable .45 ACP PDW. Packs a heavier punch at longer ranges." --Purpose Tooltip
...
SWEP.PrintName				= "HK UMP 45"		-- Weapon name (Shown on HUD)
...
SWEP.IronSightsPos_PO4X = Vector(-3.324, -5.5, 0.6)
...
SWEP.WElements = {
	...
	["flashlight"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_laser_sec.mdl", bone = "", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} , bonemerge = true, active = false },
...
function SWEP:Think2(...)
    ...
    if self.Owner:KeyPressed(IN_ZOOM) and self:GetIronSights() then 
        if self.CurrentSightState == 1 then 
			...
			self.IronSightsPos = Vector(-3.36, 0, 0.85)
			self.IronSightsAng = Vector(0.5, 0.025, 0)
			self.IronSightsPos_Kobra = Vector(-3.378, 0, 0.32)
			self.IronSightsAng_Kobra = Vector(-0.08, 0, 0)
			self.IronSightsPos_EOTech = Vector(-3.378, 0, 0.335)
			self.IronSightsAng_EOTech = Vector(-0.085, 0, 0)
			self.IronSightsPos_RDS = Vector(-3.378, 0, 0.335)
			self.IronSightsAng_RDS = Vector(-0.085, 0, 0)
			self.IronSightsPos_2XRDS = Vector(-3.376, -4.5, 0.328)
			self.IronSightsAng_2XRDS = Vector(0, 0, 0)
			self.IronSightsPos_C79 = Vector(-3.377, -4.5, 0.205)
			self.IronSightsAng_C79 = Vector(0, 0, 0)
			self.IronSightsPos_PO4X = Vector(-3.324, -5.5, 0.6)
