...
SWEP.Contact				= "https://steamcommunity.com/id/konekotoujo" 
...
SWEP.Primary.Sound          = Sound("TFA_INS2.FN.Fire")            -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound  = Sound("TFA_INS2.FN.Fire_Suppressed") -- This is the sound of the weapon, when silenced.
...
-- Recoil Related
SWEP.Primary.KickUp              = 0.221                        -- This is the maximum upwards recoil (rise)
...
SWEP.VMPos               = Vector(-0.35, 2, 0)                 -- The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
SWEP.WorldModel	  = "models/weapons/w_m9.mdl"           -- Weapon world model path
...
SWEP.IronSightsPos     = Vector(-1.855, -0.08, 0.6)
SWEP.IronSightsAng     = Vector(0, 0, 0)

SWEP.IronSightsPos_Point_Shooting = Vector(-5, 5, -1)
...
SWEP.IronSightsPos_Kobra  = Vector(-2.225, -0.08, -0.25)
SWEP.IronSightsAng_Kobra  = Vector(0, -0.012, 0)

SWEP.IronSightsPos_RDS    = Vector(-2.225, -0.08, -0.52)
SWEP.IronSightsAng_RDS    = Vector(0.28, 0.065, 0)

SWEP.IronSightsPos_EOTech = Vector(-2.225, -0.08, -0.50)
SWEP.IronSightsAng_EOTech = Vector(0, -0.012, 0)

SWEP.IronSightsPos_2XRDS  = Vector(-2.225, -0.08, -0.52)
SWEP.IronSightsAng_2XRDS  = Vector(0, 0, 0)

SWEP.IronSightsPos_C79    =  Vector(-2.225, -0.08, -0.694)
SWEP.IronSightsAng_C79    = Vector(0, 0, 0)

SWEP.IronSightsPos_PO4X   = Vector(-2.225, -0.08, -0.135)
SWEP.IronSightsAng_PO4X   = Vector(0, 0, 0)

SWEP.IronSightsPos_RMR = Vector( -1.8774, 0.28, 0.3525)
...
SWEP.WorldModelBoneMods = {
	...
	["ATTACH_Muzzle"] = { scale = Vector(0.7, 0.7, 0.7), pos = Vector(0.4, -0., -0.1), angle = Angle(0, 0, 0) },
}

SWEP.VElements = {

	["suppressor"] = { type = "Model", model = "models/weapons/upgrades/a_suppressor_pistol.mdl", bone = "A_Suppressor", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} , bonemerge = true, active = false },
	...
	["laser"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_flashlight_m9.mdl", bone = "A_Suppressor", rel = "", pos = Vector(0, -0.75, -1), angle = Angle(0, 90, 0), size = Vector(0.7, 0.7, 0.7), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
	["laser_beam"] = { type = "Model", model = "models/tfa/lbeam.mdl", bone = "A_Beam", rel = "laser", pos = Vector(-1, -0, -0.5), angle = Angle(0, 0, 0), size = Vector(2, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
	["flashlight"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_flashlight_m9.mdl", bone = "A_Suppressor", rel = "", pos = Vector(0, -0.75, -1), angle = Angle(0, 90, 0), size = Vector(0.7, 0.7, 0.7), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
	["sight_rmr"] = { type = "Model", model = "models/weapons/tfa_eft/upgrades/v_rmr.mdl", bone = "Slide", rel = "", pos = Vector(-0.02, -2.1, 0.3), angle = Angle(0, 180, 0), size = Vector(0.85, 0.95, 0.95), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = false, active = false, bodygroup = {} },
...
SWEP.WElements = {
	...
	["laser"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_laser_ins.mdl", bone = "ATTACH_Laser", rel = "ref", pos = Vector(9.5, -1.75, -8.75), angle = Angle(-4, 8.5, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
	["flashlight"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_laser_ins.mdl", bone = "ATTACH_Laser", rel = "ref", pos = Vector(9.5, -1.75, -8.75), angle = Angle(-4, 8.5, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
}
