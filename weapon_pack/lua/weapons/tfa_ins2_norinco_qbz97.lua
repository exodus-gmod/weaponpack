...
SWEP.Primary.Damage                = ( TFA and TFA.Yankys_Custom_Weapon_Pack ) and 1 * TFA.Yankys_Custom_Weapon_Pack.DamageMultiplier or 36
...
-- Recoil Related
SWEP.Primary.KickUp              = 0.1415                        -- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown            = 0                        -- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal      = 0.0865                        -- This is the maximum sideways recoil (no real term)
