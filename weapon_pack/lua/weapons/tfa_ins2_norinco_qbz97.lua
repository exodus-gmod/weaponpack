...
SWEP.Type                   = ( TFA and TFA.Yankys_Custom_Weapon_Pack ) and "Type: Bullpup Assault Rifle - Caliber: 5.56x45mm - Muzzle Velocity: 930 m/s" or "Bullpup Assault Rifle"
...
SWEP.Primary.SoundEchoTable = {
	[0]   = Sound("TFA_MWR_BOS14.TailInside"), 
	[256] = Sound("TFA_MWR_BOS14.TailOutside") 
}
...
-- Recoil Related
SWEP.Primary.KickUp              = 0.1495                        -- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown            = 0                        -- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal      = 0.0935                        -- This is the maximum sideways recoil (no real term)
...
SWEP.MuzzleFlashEffect          = ( TFA and TFA.YanKys_Realistic_Muzzleflashes ) and "tfa_muzzleflash_famas" or "tfa_muzzleflash_rifle"           
...
SWEP.VMPos          = ( TFA and TFA.Yankys_Custom_Weapon_Pack ) and Vector(-1, 0, 0) or Vector(-0.3, 0, 0)        
...
SWEP.IronSightsPos     = Vector(-3.065, -0.65, 0.157)
