...
SWEP.Purpose				= "A modern 5.45x39 assault rifle. Its high penetration rounds deal high damage, to compensate for its slow cyclic speed." --Purpose Tooltip
...
--Recoil Related
SWEP.Primary.KickUp = 0.157 -- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown = 0 -- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal = 0.090 -- This is the maximum sideways recoil (no real term)
