...
SWEP.Category			= "EXR - Equipment" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
SWEP.Manufacturer		= "H&K" --Gun Manufactrer (e.g. Hoeckler and Koch )
SWEP.Type				= "Grenade Launcher"
SWEP.Author				= "teap, Alex_D_Vasilkov" --Author Tooltip
SWEP.Description        = ""
SWEP.Contact			= "" --Contact Info Tooltip
SWEP.Purpose			= "A single shot fast acting GL." --Purpose Tooltip
SWEP.Instructions		= "" --Instructions Tooltip
SWEP.Spawnable			= true --Can you, as a normal user, spawn this?
SWEP.AdminSpawnable		= true --Can an adminstrator spawn this?  Does not tie into your admin mod necessarily, unless its coded to allow for GMod's default ranks somewhere in its code.  Evolve and ULX should work, but try to use weapon restriction rather than these.
SWEP.DrawCrosshair		= true		-- Draw the crosshair?
SWEP.DrawCrosshairIS	= false --Draw the crosshair in ironsights?
SWEP.PrintName			= "M320"		-- Weapon name (Shown on HUD)
SWEP.Slot				= 3				-- Slot in the weapon selection menu.  Subtract 1, as this starts at 0.
SWEP.SlotPos			= 1			-- Position in the slot
SWEP.AutoSwitchTo		= false		-- Auto switch to if we pick it up
SWEP.AutoSwitchFrom		= false		-- Auto switch from if you pick up a better weapon
SWEP.Weight				= 45			-- This controls how "good" the weapon is for autopickup.
...
--SWEP.FlashlightAttachment 		= 4 -- Attachment for dynamic flashlight, normally flashlight.

SWEP.TracerCount 		= 1 	--0 disables, otherwise, 1 in X chance

--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("L4D2_PORTS.M320.Fire") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.PenetrationMultiplier = 1 --Change the amount of something this gun can penetrate through
SWEP.Primary.Damage = (engine.ActiveGamemode() == "sandbox" and 200) or 200
SWEP.Primary.DamageTypeHandled = true --true will handle damagetype in base
SWEP.Primary.DamageType = nil --See DMG enum.  This might be DMG_SHOCK, DMG_BURN, DMG_BULLET, etc.  Leave nil to autodetect.  DMG_AIRBOAT opens doors.
SWEP.Primary.Force = nil --Force value, leave nil to autocalc
SWEP.Primary.Knockback = 0 --Autodetected if nil; this is the velocity kickback
SWEP.Primary.HullSize = 0.75 --Big bullets, increase this value.  They increase the hull size of the hitscan bullet.
...
SWEP.ProjectileEntity = "m320_grenade" --Entity to shoot
SWEP.ProjectileVelocity = 2550 --Entity to shoot's velocity
...
--Range Related
SWEP.Primary.Range = 300 -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/viewmodels/c_l4d2_m320.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/worldmodels/w_l4d2_m320_wm.mdl" --Wmodel path
SWEP.Bodygroups_W = {
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(3, -6, -1)
SWEP.RunSightsAng = Vector(-16, 42, -20)
...
SWEP.IronSightsPos = Vector(-2.901, -3.227, 2.092)
SWEP.IronSightsAng = Vector(-8.462, 1.2, 7.804)
SWEP.IronSightsPos_RDS = Vector(-2.931, -2, 0.5)
SWEP.IronSightsAng_RDS = Vector(-0.2, 0, 0)

--[[INSPECTION]]--
SWEP.InspectPos = Vector(5.367, -4.215, -1.688)
...
SWEP.EventTable = {
	[ACT_VM_DRAW] = {
		{time = 1 / 40, type = "sound", value = Sound("L4D2_PORTS.M320.Deploy")},
	},
	[ACT_VM_RELOAD] = {
		{time = 32 / 60, type = "sound", value = Sound("L4D2_PORTS.M320.LatchOpen")},
		{time = 37 / 60, type = "sound", value = Sound("L4D2_PORTS.M320.ShellOut")},
		{time = 90 / 60, type = "sound", value = Sound("L4D2_PORTS.M320.ShellIn")},
		{time = 137 / 60, type = "sound", value = Sound("L4D2_PORTS.M320.ActionClosed")},
	}
}
--[[ATTACHMENTS]]--
...
SWEP.SequenceLengthOverride = {
	[ACT_VM_RELOAD] = 143 / 60
}

--SWEP.Secondary.BashLength = 72
--SWEP.Secondary.BashDamage = 48
--SWEP.Secondary.BashDelay = 0.175

DEFINE_BASECLASS(SWEP.Base)


SWEP.Attachments = {
						[1] = { offset = { 0, 0 }, atts = { ""}, order = 1 },
}
