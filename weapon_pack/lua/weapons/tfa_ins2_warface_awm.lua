...
SWEP.Primary.Damage                = ( TFA and TFA.Yankys_Custom_Weapon_Pack ) and 1 * TFA.Yankys_Custom_Weapon_Pack.DamageMultiplier or 165
...
SWEP.Primary.KickHorizontal      = 0.47                       -- This is the maximum sideways recoil (no real term)
...
SWEP.VMPos                 = ( TFA and TFA.Yankys_Custom_Weapon_Pack ) and Vector(-0.8, -0.35, 0.25) or Vector(-0.1, -0.25, 0.25)           
...
SWEP.EventTable = {
	...
	[ACT_VM_PULLBACK_HIGH] = {
		{ ["time"] = 19.2 / 39, ["type"] = "lua", ["value"] = function(wep,vm)
			if wep and wep.EventShell then
				wep:EventShell()
			end
		end, ["client"] = true, ["server"] = true }
	...
	[ACT_VM_RELOAD_EMPTY] = {
		{ ["time"] = 113 / 30, ["type"] = "lua", ["value"] = function(wep,vm)
			if wep and wep.EventShell then
				wep:EventShell()
			end
		end, ["client"] = true, ["server"] = true }
...
SWEP.IronSightsPos_2XRDS     = Vector(-2.628, -2, 0.164)
...
SWEP.IronSightsPos_C79       = Vector(-2.63, -5.5, 0.128)
SWEP.IronSightsAng_C79       = Vector(0, -0.02, 0)
SWEP.Secondary.IronFOV_C79 = 65
SWEP.RTScopeFOV_C79        = 40

SWEP.IronSightsPos_PO4X      = Vector(-2.555, -5.5, 0.35)
...
SWEP.IronSightsAng_MX4       = Vector(0, -0.01, -0.85)
...
SWEP.VElements = {
	...
	["suppressor_osprey"] = { type = "Model", model = "models/weapons/tfa_eft/upgrades/v_osprey.mdl", bone = "A_Muzzle", rel = "", pos = Vector(-0.8, 0, 0), angle = Angle(0, -90, 0), size = Vector(1.25, 1.25, 1.25), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} , bonemerge = false, active = false },	
