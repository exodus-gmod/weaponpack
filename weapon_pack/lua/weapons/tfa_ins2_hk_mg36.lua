...
SWEP.Type                   = ( TFA and TFA.Yankys_Custom_Weapon_Pack ) and "Type: Squad Machinegun - Caliber: 5.56x45mm - Muzzle Velocity: 936 m/s" or "Squad Machinegun"
...
-- Recoil Related
SWEP.Primary.KickUp                = 0.285                      -- This is the maximum upwards recoil (rise)
...
SWEP.VMPos          = ( TFA and TFA.Yankys_Custom_Weapon_Pack ) and Vector(-0.65, 0, 0) or Vector(-0.1, 0, 0)
...
SWEP.IronSightsPos_2XRDS  = Vector(-2.312, -0.5, -0.66)
