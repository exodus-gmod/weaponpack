...
SWEP.Category               = "EXR - Sniper Rifles"   
SWEP.PrintName				= "McMillan CS5"	              -- Weapon name (Shown on HUD)
SWEP.Manufacturer           = "McMillan Rifles"               -- Gun Manufactrer (e.g. Hoeckler and Koch )          
SWEP.Type                   = "Bolt-Action Sniper Rifle"
SWEP.Purpose				= "A specialized integrally suppressed sniper rifle."   
SWEP.Instructions		    = ""    

SWEP.Author				    = "XxYanKy700xX & The Master MLG"    
...
SWEP.Primary.Sound             = Sound("TFA_INS2.Warface_McMillan_CS5.Fire")            -- This is the sound of the weapon, when you shoot.
-- SWEP.Primary.SilencedSound  = Sound("TFA_INS2.Warface_McMillan_CS5.Fire_Suppressed") -- This is the sound of the weapon, when silenced.
...
SWEP.Primary.Velocity              = 420                      -- Bullet Velocity in m/s
...
SWEP.Primary.KickHorizontal      = 0.56                       -- This is the maximum sideways recoil (no real term)
...
SWEP.ViewModel			   = "models/weapons/c_ins2_warface_mcmillan_cs5.mdl" 
SWEP.ViewModelFOV	       = 70		                          -- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip	       = false		                      -- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands              = true                             -- Use gmod c_arms system.

SWEP.VMPos                 = ( TFA and TFA.Yankys_Custom_Weapon_Pack ) and Vector(-1.8, 0, 0) or Vector(-1.15, 0, 0)
...
SWEP.EventTable = {
	[ACT_VM_PULLBACK_LOW] = {
		{ ["time"] = 16 / 39, ["type"] = "lua", ["value"] = function(wep,vm)
	...
	[ACT_VM_PULLBACK_HIGH] = {
		{ ["time"] = 19.3 / 39, ["type"] = "lua", ["value"] = function(wep,vm)
			if wep and wep.EventShell then
				wep:EventShell()
			end
		end, ["client"] = true, ["server"] = true }
	...
	[ACT_VM_RELOAD_EMPTY] = {
		{ ["time"] = 24.65 / 30, ["type"] = "lua", ["value"] = function(wep,vm)
			if wep and wep.EventShell then
				wep:EventShell()
			end
		end, ["client"] = true, ["server"] = true }
...
SWEP.WorldModel	   = "models/weapons/w_ins2_warface_mcmillan_cs5.mdl" -- Weapon world model path
...
SWEP.IronSightsPos     = Vector(-3.625, -0.45, 0.285)
SWEP.IronSightsAng     = Vector(0, 0.06, 0)
...
SWEP.IronSightsPos_Kobra     = Vector(-3.635, -0.5, 0.2)
SWEP.IronSightsAng_Kobra     = Vector(0.1, 0.005, 0)

SWEP.IronSightsPos_EOTech    =  Vector(-3.635, -0.5, 0.028)
SWEP.IronSightsAng_EOTech    = Vector(-0.1, -0.01, 0)

SWEP.IronSightsPos_RDS       = Vector(-3.635, -0.5, 0.155)  
SWEP.IronSightsAng_RDS       = Vector(0, -0.015, 0)

SWEP.IronSightsPos_2XRDS     = Vector(-3.63, -3, 0.23)
SWEP.IronSightsAng_2XRDS     = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_2XRDS = 65
SWEP.RTScopeFOV_2XRDS        = 30

SWEP.IronSightsPos_Mosin     = Vector(-3.6125, -2, 0.7)
SWEP.IronSightsAng_Mosin     = Vector(0, -0.0265, 0)
SWEP.RTScopeFOV_Mosin        = 55

SWEP.IronSightsPos_C79       = Vector(-3.627, -3, -0.116)
SWEP.IronSightsAng_C79       = Vector(0, -0.008, 0)
SWEP.RTScopeFOV_C79          = 50

SWEP.IronSightsPos_PO4X      = Vector(-3.573, -2, 0.34)
SWEP.IronSightsAng_PO4X      = Vector(0, -0.01, 0)
SWEP.Secondary.IronFOV_PO4X  = 65
SWEP.RTScopeFOV_PO4X         = 45

SWEP.IronSightsPos_MX4       = Vector(-3.64, -2, 0.11)
...
SWEP.CrouchPos    = Vector(-0.5, -0.75, -0.5) + SWEP.VMPos
SWEP.CrouchAng    = Vector(0, 0, -5) + SWEP.VMAng

--[[INSPECTION]]--

SWEP.InspectPos   = Vector(6.8, -4.8, -2.241) 
SWEP.InspectAng   = Vector(25, 45, 15.477)

--[[ATTACHMENTS]]--

SWEP.Attachments = {
	[1] = { atts = { "ins2_si_c79", "ins2_si_mx4" }},
	[3] = { atts = { "ins2_ub_laser", "ins2_ub_flashlight" }},
	[2] = { atts = { "ins2_br_heavy", "ins2_br_light" }},
	[4] = { atts = { "am_match_snpr", "am_magnum_snpr", "am_gib_snpr" }},
}
...
SWEP.ViewModelBoneMods = {
	...
	["A_Suppressor"] = { scale = Vector(0.9, 1, 0.9), pos = Vector(-0.02, 0, 0.), angle = Angle(0, 0, 0) },
	["A_LaserFlashlight"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },

	["R Finger0"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-3, 6.5, 0) },
	["R Finger1"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, -5.5, 0) },

	["L UpperArm"] = { scale = Vector(1, 1, 1), pos = Vector(0.2, 0, -0.1), angle = Angle(0, 0, 0) },
	["L Finger1"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0.05, 0), angle = Angle(0, -1, 0) },
	["L Finger2"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0.05, 0), angle = Angle(0, -10, 0) },
	["L Finger3"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0.05, 0), angle = Angle(0, -2, 0) },
	["L Finger4"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0.05, 0), angle = Angle(0, -20, 0) },
}	
...
SWEP.VElements = {
	["sights_folded"] = { type = "Model", model = "models/weapons/upgrades/a_standard_cs5.mdl", bone = "A_Optic", rel = "", pos = Vector(-2.62, 1.46, -12.5), angle = Angle(90, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = true},
...
--	["suppressor_osprey"] = { type = "Model", model = "models/weapons/tfa_eft/upgrades/v_osprey.mdl", bone = "A_Muzzle", rel = "", pos = Vector(-0.8, 0, 0), angle = Angle(90, -90, 0), size = Vector(1.25, 1.25, 1.25), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} , bonemerge = false, active = false },	
	...
	["laser"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_laser_rail.mdl", bone = "A_UnderBarrel", rel = "", pos = Vector(0, 0, -0.042), angle = Angle(0, 0, 180), size = Vector(0.9, 0.9 ,0.9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
	...
	["flashlight_lastac"] = { type = "Model", model = "models/weapons/tfa_eft/upgrades/v_lastac.mdl", bone = "A_LaserFlashlight", rel = "", pos = Vector(0, -0.2, -0.05), angle = Angle(-90, -90, 0), size = Vector(0.85, 0.85, 0.85), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = false, active = false, bodygroup = {} },
}
...
SWEP.WElements = {
	...
	["sights_folded"] = { type = "Model", model = "models/weapons/upgrades/a_standard_cs5.mdl", bone = "A_Optic", rel = "ref", pos = Vector(-1.2, -3.1, 6.3), angle = Angle(2.8, -1, 5), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = true },
...
if TFA.Yankys_Custom_Weapon_Pack then
    ...
    SWEP.AmmoTypeStrings = {
	    sniperpenetratedround = "7.62x51mm NATO Subsonic"
    }
