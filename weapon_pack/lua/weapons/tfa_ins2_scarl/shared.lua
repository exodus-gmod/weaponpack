...
--Recoil Related
SWEP.Primary.KickUp = 0.148 -- This is the maximum upwards recoil (rise)
...
SWEP.VElements = {
	...
	["sight_kobra"] = { type = "Model", model = "models/weapons/upblitz/a_optic_kobra_lp.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 1), angle = Angle(90, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
