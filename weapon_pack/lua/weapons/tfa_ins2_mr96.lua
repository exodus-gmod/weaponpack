...
SWEP.Primary.KickHorizontal      = 0.425                         -- This is the maximum sideways recoil (no real term)
...
SWEP.Primary.MinRangeStartFalloff = 50 -- How long will bullet travel in Meters before starting to lose damage?
...
SWEP.Attachments = {
	[1] = { atts = { "r6s_muzzle_2", "r6s_flashhider_2", "bo2_longbarrel" } },
