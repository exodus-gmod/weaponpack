...
SWEP.Purpose				= "An old timey magazine fed pistol. Still holds its own against more modern alternatives." --Purpose Tooltip
...
SWEP.PrintName				= "Smith & Wesson Model 659"		-- Weapon name (Shown on HUD)
...
--Recoil Related
SWEP.Primary.KickUp = 0.219 -- This is the maximum upwards recoil (rise)
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2/c_sw659.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2/w_sw659.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-3.605, 0, 0.58)
SWEP.IronSightsAng = Vector(-0.044, 0, 0)
--[[INSPECTION]]--
...
SWEP.VElements = {
	...
	["laser"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_laser_mak.mdl", bone = "", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = true, active = false, bodygroup = {} },
	["laser_beam"] = { type = "Model", model = "models/tfa/lbeam.mdl", bone = "Laser_mak", rel = "laser", pos = Vector(0, 0, 0), angle = Angle(0, 90, 0), size = Vector(2, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false },
}

SWEP.WElements = {
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_sil_pistol.mdl", bone = "ATTACH_Muzzle", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
