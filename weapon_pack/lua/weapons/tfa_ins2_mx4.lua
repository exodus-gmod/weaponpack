...
SWEP.Purpose				= "A compact, robust PDW primarily used in V.I.P protection." --Purpose Tooltip
SWEP.Instructions				= "" --Instructions Tooltip
SWEP.Spawnable				= true --Can you, as a normal user, spawn this?
SWEP.AdminSpawnable			= true --Can an adminstrator spawn this?  Does not tie into your admin mod necessarily, unless its coded to allow for GMod's default ranks somewhere in its code.  Evolve and ULX should work, but try to use weapon restriction rather than these.
SWEP.DrawCrosshair			= true		-- Draw the crosshair?
SWEP.DrawCrosshairIS = false --Draw the crosshair in ironsights?
SWEP.PrintName				= "Beretta Mx4 Storm"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_INS2.MX4.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_INS2.MX4.2") -- This is the sound of the weapon, when silenced.
...
SWEP.IronBobMult			= 0					-- More is more bobbing, proportionally. Make this < 1 for sighting, 0 to outright disable.  			
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2/c_mx4.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2/w_mx4.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-2.55, -2, 1)
SWEP.IronSightsAng = Vector(0, 0.02, 0)

SWEP.IronSightsPos_Kobra = Vector(-2.55, -2, 0)
SWEP.IronSightsAng_Kobra = Vector(0, 0.02, 0)

SWEP.IronSightsPos_EOTech = Vector(-2.55, -2, 0)
SWEP.IronSightsAng_EOTech = Vector(0, 0.02, 0)

SWEP.IronSightsPos_RDS = Vector(-2.55, -2, 0)
SWEP.IronSightsAng_RDS = Vector(0, 0.02, 0)

SWEP.IronSightsPos_2XRDS = Vector(-2.55, -2, 0)
...
SWEP.SprintAnimation = {
	["loop"] = {
		...
		["value_empty"] = "base_sprint_loop_empty",
		["is_idle"] = true
	}
}
--[[EFFECTS]]--
...
SWEP.EventTable = {
	["base_draw"] = {
		{time = 0, type = "sound", value = Sound("TFA_INS2.MX4.Draw")},
	},
	["base_holster"] = {
		{time = 0, type = "sound", value = Sound("TFA_INS2.MX4.Holster")},
	},
	["base_fidget"] = {
		{time = 0.1, type = "sound", value = Sound("TFA_INS2.MX4.Rustle")},
		{time = 2.9, type = "sound", value = Sound("TFA_INS2.MX4.Rustle")},
		{time = 5.8, type = "sound", value = Sound("TFA_INS2.MX4.Boltrelease")},
		{time = 7, type = "sound", value = Sound("TFA_INS2.MX4.Boltforward")},
		{time = 7.6, type = "sound", value = Sound("TFA_INS2.MX4.Rustle")},
	},
	["base_fidget_empty"] = {
		{time = 0.1, type = "sound", value = Sound("TFA_INS2.MX4.Rustle")},
		{time = 2.9, type = "sound", value = Sound("TFA_INS2.MX4.Rustle")},
		{time = 5.4, type = "sound", value = Sound("TFA_INS2.MX4.Rustle")},
	},
	["base_ready"] = {
		{time = 0.2, type = "sound", value = Sound("TFA_INS2.MX4.Boltrelease")},
		{time = 0.4, type = "sound", value = Sound("TFA_INS2.MX4.Boltforward")},
		{time = 0.8, type = "sound", value = Sound("TFA_INS2.MX4.Rustle")},
	},
	["base_reload"] = {
		{time = 0.1, type = "sound", value = Sound("TFA_INS2.MX4.Rustle")},
		{time = 0.2, type = "sound", value = Sound("TFA_INS2.MX4.MagoutHalf")},
		{time = 0.8, type = "sound", value = Sound("TFA_INS2.MX4.MaginHalf")},
		{time = 1.5, type = "sound", value = Sound("TFA_INS2.MX4.Rustle")},
	},
	["base_reload_empty"] = {
		{time = 0.1, type = "sound", value = Sound("TFA_INS2.MX4.Rustle")},
		{time = 0.2, type = "sound", value = Sound("TFA_INS2.MX4.Magout")},
		{time = 1.2, type = "sound", value = Sound("TFA_INS2.MX4.Magin")},
		{time = 1.7, type = "sound", value = Sound("TFA_INS2.MX4.Boltrelease")},
		{time = 1.8, type = "sound", value = Sound("TFA_INS2.MX4.Boltforward")},
		{time = 2.2, type = "sound", value = Sound("TFA_INS2.MX4.Rustle")},
	},
}
--Attachments
...
SWEP.Attachments = {
	...
	[9] = { offset = { 0, 0 }, atts = { "ins2_si_kobra", "ins2_si_eotech", "ins2_si_rds" }, order = 1 },
	[8] = { offset = { 0, 0 }, atts = { "ins2_ub_laser", "ins2_ub_flashlight" }, order = 4 },
}
