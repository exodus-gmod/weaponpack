...
SWEP.Category               = ( TFA and TFA.Yankys_Custom_Weapon_Pack_Categories ) and "[TFA] [AT] [ Equipment ]" or "EXR - Equipment"
SWEP.Author					= "The Master MLG & XxYanKy700xX"
SWEP.Manufacturer           = "U.S.A" 
SWEP.Contact				= ""
SWEP.PrintName				= "ANM-14 Incendiary Grenade"  		           
SWEP.Purpose				= "An incredibly high burning thermite grenade that leaves flames in its wake. For use as area denial against SCPs."
SWEP.Type                   = "Anti-SCP Incendiary Grenade"
SWEP.Slot					= 4
SWEP.SlotPos				= 1
SWEP.DrawAmmo				= true
...
SWEP.Delay                  = 0.2
SWEP.DelayCooked            = 0.15
SWEP.Delay_Underhand        = 0.2
SWEP.CookStartDelay         = 0.1
