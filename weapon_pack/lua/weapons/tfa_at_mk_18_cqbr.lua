...
--Recoil Related
SWEP.Primary.KickUp = 0.124 -- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown = 0 -- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal = 0.082 -- This is the maximum sideways recoil (no real term)
...
SWEP.Attachments = {
	...
	[4] = { atts = { "ins2_si_kobra", "ins2_si_eotech", "ins2_si_rds", "ins2_si_2xrds", "ins2_si_c79", "ins2_si_c792" }, order = 1 },
