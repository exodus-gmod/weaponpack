...
SWEP.Manufacturer = "Daniel Defense & Colt's Patent Fire Arms Manufacturing Company" --Gun Manufactrer (e.g. Hoeckler and Koch )
SWEP.Author				= "Lucho" --Author Tooltip
SWEP.Contact				= "" --Contact Info Tooltip
SWEP.Purpose				= "A mobile carbine, mixing the power of an assault rifle with the flexibility and speed of an SMG." --Purpose Tooltip
...
SWEP.PrintName				= "MK18 Mod 1 CQBR"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("Weapon_MK18.Fp") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("Weapon_MK18.Suppressed_Fp") -- This is the sound of the weapon, when silenced.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/mk18/v_mk18_3.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/mk18/w_mk18.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-2.418, -1, 1.1)
SWEP.IronSightsAng = Vector(0.5, 0, 0)

SWEP.IronSightsPos_1P87 = Vector(-2.415, -2, 1.12)
SWEP.IronSightsAng_1P87 = Vector(0.5, 0, 0)

SWEP.IronSightsPos_RDS = Vector(-2.415, -2, 1)
SWEP.IronSightsAng_RDS = Vector(0, 0, 0)

SWEP.IronSightsPos_EOTech = Vector(-2.415, -2, 1.185)
SWEP.IronSightsAng_EOTech = Vector(0, 0, 0)

SWEP.IronSightsPos_Kobra = Vector(-2.415, -2, 1.2)
SWEP.IronSightsAng_Kobra = Vector(0, 0, 0)

SWEP.IronSightsPos_2XRDS = Vector(-2.411, -3, 0.99)
SWEP.IronSightsAng_2XRDS = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_2XRDS = 65
SWEP.RTScopeFOV_2XRDS        = 30

SWEP.IronSightsPos_C792 = Vector(-2.415, -2, -0.2)
SWEP.IronSightsAng_C792 = Vector(-0.4, 0, 0)

SWEP.IronSightsPos_C79 = Vector(-2.413, -4., 0.883)
SWEP.IronSightsAng_C79 = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_C79 = 65
SWEP.RTScopeFOV_C79        = 50

SWEP.IronSightsPos_PO4X = Vector(-2.352, -5, 1.293)
SWEP.IronSightsAng_PO4X = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_PO4X = 65
SWEP.RTScopeFOV_PO4X        = 50

SWEP.IronSightsPos_RMRCanted = Vector(-3.84, -3., 1.78)
...
SWEP.ViewModelBoneMods = {
	["A_Foregrip"] = { scale = Vector(0.31, 0.31, 0.31), pos = Vector(0, 0, -0.15), angle = Angle(0,0,0) },
	["A_Suppressor"] = { scale = Vector(0.5, 0.7, 0.5), pos = Vector(0, 0, 0), angle = Angle(0,0,0) },
	["A_Optic"] = { scale = Vector(0.9, 0.9, 0.8), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },

}

SWEP.WorldModelBoneMods = {
	["ATTACH_Muzzle"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["ATTACH_Laser"] = { scale = Vector(1, 1, 1), pos = Vector(-4.5, 0.45, -1.5), angle = Angle(0, 0, 90) },
	["ATTACH_Foregrip"] = { scale = Vector(.75, .75, .75), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
     
}

SWEP.VElements = {
	["sight_1p87"] = { type = "Model", model = "models/weapons/mk_18_mod_1/upgrades/a_standard_mk18.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
	...
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_suppressor_sec.mdl", bone = "A_Suppressor", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(10, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} , bonemerge = true, active = false },
	...
	["laser"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_laser_anpeq15_tan.mdl", bone = "A_LaserFlashlight", rel = "", pos = Vector(0, 2, -1.15), angle = Angle(0, 0, -90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
	["scope_c792"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_elcan_m.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
	["laser_beam"] = { type = "Model", model = "models/tfa/lbeam.mdl", bone = "A_Beam", rel = "laser", pos = Vector(0, -0.3, 0.5), angle = Angle(0, 0, 0), size = Vector(2, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
	...
	["flashlight"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_laser_anpeq15_tan.mdl", bone = "A_LaserFlashlight", rel = "", pos = Vector(0, 2, -1.15), angle = Angle(0, 0, -90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
...
SWEP.WElements = {
	...
	["scope_c792"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_elcan.mdl", bone = "", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
	...
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_sil_sec1.mdl", bone = "", rel = "", pos = Vector(-5.5, -1.5, 9), angle = Angle(3, -5.1, 0), size = Vector(0.6, 0.6, 0.6), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
	...
	["flashlight"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_laser_sec.mdl", bone = "", rel = "", pos = Vector(15, 12, 4.6), angle = Angle(3, -5, -90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
	["laser"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_laser_sec.mdl", bone = "", rel = "", pos = Vector(15, 12, 4.6), angle = Angle(3, -5, -90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
...
SWEP.Attachments = {
	...
	[4] = { atts = { "ins2_si_kobra", "ins2_si_eotech", "ins2_si_rds", "ins2_si_2xrds", "ins2_si_c79" }, order = 1 },
	[5] = { offset = { 0, 0 }, atts = { "ins2_fg_grip" }, order = 4 },
	[6] = { offset = { 0, 0 }, atts = { "ins2_ub_laser", "ins2_ub_flashlight1" }, order = 5 },
}
...
SWEP.RTAttachment_G33           = 2
SWEP.ScopeDistanceRange_G33     = 50
SWEP.ScopeDistanceMin_G33       = 50

SWEP.RTAttachment_ELCAN_C79             = 2
SWEP.ScopeDistanceRange_ELCAN_C79       = 50
SWEP.ScopeDistanceMin_ELCAN_C79         = 50

SWEP.RTAttachment_ELCAN_SU230             = 2
SWEP.ScopeDistanceRange_ELCAN_SU230       = 50
SWEP.ScopeDistanceMin_ELCAN_SU230         = 50

SWEP.RTAttachment_QTS11            = 1
SWEP.ScopeDistanceRange_QTS11      = 50
SWEP.ScopeDistanceMin_QTS11        = 50
...
function SWEP:Think2(...)
    ...
    if self.Owner:KeyPressed(IN_ZOOM) and self:GetIronSights() then 
        if self.CurrentSightState == 1 then 
			...
			self.IronSightsPos_1P87 = Vector(-2.415, -2, 1.12)
			self.IronSightsAng_1P87 = Vector(0.5, 0, 0)
			self.IronSightsPos = Vector(-2.418, -1, 1.1)
			self.IronSightsAng = Vector(0.5, 0, 0)
			self.IronSightsPos_Kobra = Vector(-2.415, -2, 1.2)
			self.IronSightsAng_Kobra = Vector(0, 0, 0)
			self.IronSightsPos_EOTech = Vector(-2.415, -2, 1.185)
			self.IronSightsAng_EOTech = Vector(0, 0, 0)
			self.IronSightsPos_RDS = Vector(-2.415, -2, 1)
			self.IronSightsAng_RDS = Vector(0, 0, 0)
			self.IronSightsPos_2XRDS = Vector(-2.411, -3, 0.99)
			self.IronSightsAng_2XRDS = Vector(0, 0, 0)
			self.IronSightsPos_C79 = Vector(-2.413, -4., 0.883)
			self.IronSightsAng_C79 = Vector(0, 0, 0)
			self.IronSightsPos_PO4X = Vector(-2.352, -5, 1.293)
