...
SWEP.Purpose				= "A personally modified AK-74. Built to match personal tastes. Its high modularity and low weight attachment mounts allow for effective CQC combat." --Purpose Tooltip
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_INS2.AK105.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_INS2.AK105.2") -- This is the sound of the weapon, when silenced.

SWEP.Primary.LoopSound = Sound("TFA_INS2.EFTAK74.LOOP.1") -- Looped fire sound, unsilenced
SWEP.Primary.LoopSoundSilenced = Sound("TFA_INS2.EFTAK74.LOOP.2") -- Looped fire sound, silenced
SWEP.Primary.LoopSoundTail = Sound("TFA_INS2.EFTAK74.LOOP.TAIL.1") -- Loop end/tail sound, unsilenced
...
SWEP.InspectAng = Vector(26.733, 48.542, 29.548)
...
SWEP.ViewModelBoneMods = {
	...
	["A_Optic"] = { scale = Vector(1, 1, 1), pos = Vector(-0.03, 0.75, 0.6), angle = Angle(0, 0, 0) },
	["A_Muzzle"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, 0, -90) },
	["A_Modkit"] = { scale = Vector(1, 1, 1), pos = Vector(-0.05, -0.5, 0), angle = Angle(0, 0, 0) },
	["A_GL"] = { scale = Vector(0.75, 0.75, 0.75), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["A_LaserFlashlight"] = { scale = Vector(1, 1, 1), pos = Vector(0.9, 4, -0.9), angle = Angle(0, 0, -180) },
	["A_Foregrips"] = { scale = Vector(0.4, 0.4, 0.4), pos = Vector(0, 0, -1), angle = Angle(0, 0, 0) },
}

SWEP.WorldModelBoneMods = {
	["ATTACH_Muzzle"] = { scale = Vector(.75, .75, .75), pos = Vector(-2, 0, 0), angle = Angle(0, 0, 0) },
	["ATTACH_Laser"] = { scale = Vector(1, 1, 1), pos = Vector(-5, 0.5, 1.5), angle = Angle(0, 0,180) },
	["ATTACH_Foregrip"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["ATTACH_ModKit"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
}

SWEP.VElements = {
	["rail_sights"] = { type = "Model", model = "models/weapons/upgrades/upgrades/a_mount_b13v.mdl", bone = "A_Optic", rel = "", pos = Vector(0, -1.55, -12.15), angle = Angle(180, 0, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false},
	...
	["suppressor"] = { type = "Model", model = "models/weapons/upgrades/upgrades/a_suppressor_pbs4.mdl", bone = "A_Suppressor", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} , bonemerge = true, active = false },
	["flashlight"] = { type = "Model", model = "models/weapons/tfa_eft/upgrades/tactical/WF501B/v_wf501b.mdl", bone = "A_LaserFlashlight", rel = "", pos = Vector(5.1, -0.1, -0.3), angle = Angle(0, 0, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },	
	["foregrip"] = { type = "Model", model = "models/weapons/upgrades/upgrades/a_foregrip_rk1.mdl", bone = "A_Foregrip", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 90, 0), size = Vector(0.485, 0.485, 0.485), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },	
	["laser"] = { type = "Model", model = "models/weapons/tfa_eft/upgrades/tactical/Perst3/v_perst3.mdl", bone = "A_LaserFlashlight", rel = "", pos = Vector(5.1, 1.5, -0.3), angle = Angle(0, 0, -90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
	["laser_beam"] = { type = "Model", model = "models/tfa/lbeam.mdl", bone = "A_Beam", rel = "laser", pos = Vector(0.75, 0, -1.5), angle = Angle(0, 0, 0), size = Vector(2, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
}
