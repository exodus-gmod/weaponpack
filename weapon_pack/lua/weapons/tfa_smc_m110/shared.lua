...
SWEP.Category				= "EXR - DMRs" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
SWEP.Manufacturer = "Knight's Armaments" --Gun Manufactrer (e.g. Hoeckler and Koch )
SWEP.Author				= "TFA - Edit by Lucho" --Author Tooltip
SWEP.Contact				= "http://steamcommunity.com/profiles/76561198161775645" --Contact Info Tooltip
SWEP.Purpose				= "A military DMR built for long range combat and suppression." --Purpose Tooltip
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_INS2_M110.FIRE") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_INS2_M110.FIRE_SUPPRESSED") -- This is the sound of the weapon, when silenced.

SWEP.Primary.SoundEchoTable = {
	[0] = Sound("SMC_SR25.INDOORS1"), -- This is the sound of the weapon, when you shoot.
	[700] = Sound("SMC_m110.OUTDOORS1") -- This is the sound of the weapon, when you shoot.
}

--[[EVENT TABLE]]--
SWEP.EventTable = {
	["base_reload"] = {
		{["time"] = 0.9, ["type"] = "sound", ["value"] = Sound("M14_MAGIN2"), ["server"] = false, ["client"] = true},
	},
	["base_reloadempty"] = {
		{["time"] = 0.9, ["type"] = "sound", ["value"] = Sound("M14_MAGIN"), ["server"] = false, ["client"] = true},
	},
	["base_firelast"] = {
		{["time"] = 0, ["type"] = "sound", ["value"] = Sound("TFA_DEVL.443.SlideLock"), ["server"] = false, ["client"] = true},
	},
	["iron_firelast"] = {
		{["time"] = 0, ["type"] = "sound", ["value"] = Sound("TFA_DEVL.443.SlideLock"), ["server"] = false, ["client"] = true},
	},
	["base_dryfire"] = {
		{["time"] = 1 / 18, ["type"] = "sound", ["value"] = Sound("TFA_DEVL.Empty"), ["server"] = false, ["client"] = true},
	},
}
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/folder for cool people only/v_m14.mdl" --Viewmodel path
SWEP.ViewModelFOV			= 70 -- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip			= false		-- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands = true --Use gmod c_arms system.
SWEP.VMPos = Vector(-0.8,-2,-0.5) --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/folder for cool people only/w_m14.mdl" -- Weapon world model path
...
SWEP.RunSightsAng = Vector(-5, 15, 0) --Change this, using SWEP Creation Kit preferably
--[[IRONSIGHTS]]--
SWEP.data = {}
...
SWEP.IronSightsPos_MX4 = Vector(-3.075, -3, 0.67)
SWEP.IronSightsAng_MX4 = Vector(0, 0, -0.7)
...
SWEP.WorldModelBoneMods = {
	["ATTACH_ModKit"] = { scale = Vector(0.85, 0.85, 0.85), pos = Vector(0, 0, 0.25), angle = Angle(0, 0, 0) },
}
...
SWEP.VElements = {
	...
	["sight_eotech"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_eotech_l.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(90, 90, 0), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
	["sight_eotech_lens"] = (TFA.INS2 and TFA.INS2.GetHoloSightReticle) and TFA.INS2.GetHoloSightReticle("sight_eotech") or nil,
	["sight_rds"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_aimpoint_l.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(90, 90, 0), size = Vector(0.85, 0.85, 0.85), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
	["sight_rds_lens"] = (TFA.INS2 and TFA.INS2.GetHoloSightReticle) and TFA.INS2.GetHoloSightReticle("sight_rds") or nil,
	
	["scope_2xrds"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_aimp2x_l.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(90, 90, 0), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
	["scope_c79"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_elcan_l.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(90, 90, 0), size = Vector(0.65, 0.65, 0.65), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
		
	["scope_po4x"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_po4x24_m.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0.1, 0), angle = Angle(90, 90, 0), size = Vector(0.9, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
	...
	["scope_mx4"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_m40_l.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0.1, 0), angle = Angle(90, 0, 90), size = Vector(0.8, 0.8, 0.81), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
	
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_suppressor_sec.mdl", bone = "A_Suppressor", rel = "", pos = Vector(0, 5, 0), angle = Angle(0, 90, 0), size = Vector(1.3, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} , bonemerge = false, active = false },
	...
	["laser"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_laser_anpeq15_tan.mdl", bone = "A_Optic", rel = "", pos = Vector(-1, 0, 10.5), angle = Angle(90, 180, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
	["laser_beam"] = { type = "Model", model = "models/tfa/lbeam.mdl", bone = "ValveBiped.Bip01_Spine4", rel = "laser", pos = Vector(0, -0.3, 1.5), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false},	
...
SWEP.WElements = {
	...
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_sil_sec1.mdl", bone = "ATTACH_Muzzle", rel = "ref", pos = Vector(-15.5 , -2.8, 11.), angle = Angle(3, -5.5, 0), size = Vector(1, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
...
SWEP.Attachments = {
	...
	[2] = { offset = { 0, 0 }, atts = { "am_match_dmr", "am_magnum_dmr", "am_gib_dmr" }, order = 5 },
	[3] = { offset = { 0, 0 }, atts = { "ins2_br_heavy", "ins2_br_light"  }, order = 3 },
	[7] = { offset = { 0, 0 }, atts = { "ins2_si_eotech", "ins2_si_rds", "ins2_si_2xrds", "ins2_si_c79", "ins2_si_mx4" }, order = 1 },
...
function SWEP:Think2(...)
    ...
    if self.Owner:KeyPressed(IN_ZOOM) and self:GetIronSights() then 
        if self.CurrentSightState == 1 then 
			...
			self.IronSightsPos = Vector(-3.07, -2.1, 1.45)
			self.IronSightsAng = Vector(0, 0, 0)
			self.IronSightsPos_Kobra = Vector(-2.624, -3.5, -0.415)
			self.IronSightsAng_Kobra = Vector(0, 0, 0)
			self.IronSightsPos_EOTech = Vector(-3.07, -3.5, 0.56)
			self.IronSightsAng_EOTech = Vector(0, 0, 0)
			self.IronSightsPos_RDS = Vector(-3.065, -6, 0.49)
			self.IronSightsAng_RDS = Vector(0, 0, 0)
			self.IronSightsPos_2XRDS = Vector(-3.06, -4, 0.49)
			self.IronSightsAng_2XRDS = Vector(0, 0, 0)
			self.IronSightsPos_C79 = Vector(-3.0645, -4.5, 0.5)
