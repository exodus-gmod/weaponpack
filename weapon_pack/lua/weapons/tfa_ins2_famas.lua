...
SWEP.Purpose				= "A burst fire bullpup assault rifle. Bolsters good controllability." --Purpose Tooltip
...
if killicon and killicon.Add then
	killicon.Add("tfa_ins2_famas", "vgui/killicons/tfa_ins2_famas", Color(255, 80, 0, 191))
end
...
SWEP.Attachments = {
	...
	[6] = { offset = { 0, 0 }, atts = { "ins2_ub_laser", "ins2_ub_flashlight" }, order = 5 },
