...
SWEP.Manufacturer = "Kimber" --Gun Manufactrer (e.g. Hoeckler and Koch )
SWEP.Author				= "NB - Edit by Lucho" --Author Tooltip
SWEP.Contact				= "" --Contact Info Tooltip
SWEP.Purpose				= "A more heavily modified 1911 variant. Comes with special glow sights and .45 ACP firepower." --Purpose Tooltip
SWEP.Instructions				= "" --Instructions Tooltip
SWEP.Spawnable				= true --Can you, as a normal user, spawn this?
SWEP.AdminSpawnable			= true --Can an adminstrator spawn this?  Does not tie into your admin mod necessarily, unless its coded to allow for GMod's default ranks somewhere in its code.  Evolve and ULX should work, but try to use weapon restriction rather than these.
SWEP.DrawCrosshair			= true		-- Draw the crosshair?
SWEP.DrawCrosshairIS = false --Draw the crosshair in ironsights?
SWEP.PrintName				= "Kimber Night Warrior"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_INS2_KIMBERNW.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_INS2_KIMBERNW.2") -- This is the sound of the weapon, when silenced.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/c_nb_ins_knw.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/w_nb_ins_knw.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-1.85, -2.6, 0.34)
...
SWEP.Attachments = {
	...
	[3] = { offset = { 0, 0 }, atts = { "am_match", "am_magnum", "am_gib" }, order = 5 },
	[7] = { offset = { 0, 0 }, atts = { "ins2_mag_ext_pistol" }, order = 3 },
	[9] = { offset = { 0, 0 }, atts = { "ins2_ub_laser", "ins2_ub_flashlight1" }, order = 4 }
}
SWEP.AttachmentDependencies = {}
SWEP.AttachmentExclusions = {}

SWEP.VElements = {
	["mag"] = { type = "Model", model = "models/weapons/upgrades/a_magazine_m45_8.mdl", bone = "Magazine", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = true },
	["laser"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_laser_rail.mdl", bone = "A_Underbarrel", rel = "", pos = Vector(-0.798, 0.012, 0.2), angle = Angle(0, 0, 0), size = Vector(0.7, 0.7, 0.7), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
	["laser_beam"] = { type = "Model", model = "models/tfa/lbeam.mdl", bone = "A_Underbarrel", rel = "", pos = Vector(0,-0.15,-0.55), angle = Angle(0, 0, 0), size = Vector(2, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
	["mag_ext"] = { type = "Model", model = "models/weapons/upgrades/a_magazine_m45_15.mdl", bone = "Magazine", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_suppressor_pistol.mdl", bone = "A_Suppressor", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 90, 0), size = Vector(0.7, 0.7, 0.7), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
	["flashlight"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_flashlight_rail.mdl", bone = "A_Underbarrel", rel = "", pos = Vector(-1, 0, 0.2), angle = Angle(0, 0, 0), size = Vector(0.6, 0.65, 0.65), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
}
