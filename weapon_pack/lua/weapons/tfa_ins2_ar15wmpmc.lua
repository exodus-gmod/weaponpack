...
SWEP.Manufacturer = "MagPul" --Gun Manufactrer (e.g. Hoeckler and Koch )
SWEP.Author				= "SethSamson & Mendes" --Author Tooltip
SWEP.Contact				= "" --Contact Info Tooltip
SWEP.Purpose				= "A shorter barrel, custom AR-15 built for PMC groups." --Purpose Tooltip
SWEP.Instructions				= "" --Instructions Tooltip
SWEP.Spawnable				= true --Can you, as a normal user, spawn this?
SWEP.AdminSpawnable			= true --Can an adminstrator spawn this?  Does not tie into your admin mod necessarily, unless its coded to allow for GMod's default ranks somewhere in its code.  Evolve and ULX should work, but try to use weapon restriction rather than these.
SWEP.DrawCrosshair			= true		-- Draw the crosshair?
SWEP.DrawCrosshairIS = false --Draw the crosshair in ironsights?
SWEP.PrintName				= "AR-15 Warrior PMC"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.SilencedSound = Sound("TFA_INS2_SCARL.2") -- This is the sound of the weapon, when silenced.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2_ar15wmpmc/v_m4a1.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2_ar15wmpmc/w_m4a1.mdl" -- Weapon world model path
...
SWEP.ViewModelBoneMods = {
	["A_Foregrip"] = { scale = Vector(.6,.6,.6), pos = Vector(0, 0, 0), angle = Angle(0,0,0) },
	["A_Suppressor"] = { scale = Vector(1.1,1.1,1.1), pos = Vector(0.2, 0, 0.1), angle = Angle(0,0,0) },
	["A_LaserFlashlight"] = { scale = Vector(1.1,1.1,1.1), pos = Vector(1, -3, 0), angle = Angle(0,0,0) },
	["A_Optic"] = { scale = Vector(.9,.9,.9), pos = Vector(0, -0.3, 0), angle = Angle(0,0,0) },
	["laser_beam"] = { scale = Vector(1.1,1.1,1.1), pos = Vector(0, -1.5, 0), angle = Angle(0,0,0) },
	["A_GL"] = { scale = Vector(1.1,1.1,1.1), pos = Vector(0, 1, 0), angle = Angle(0,0,0) }
}
...
SWEP.VElements = {
	--["sights_folded"] = { type = "Model", model = "models/weapons/tfa_ins2_ar15wmpmc/upgrades/a_standard6_m4a1.mdl", bone = "A_Optic", rel = "", pos = Vector(0, -0.245, 0.159), angle = Angle(0, -90, 0), size = Vector(0.611, 0.611, 0.611), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = true},
	...
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2_ar15wmpmc/upgrades/a_suppressor_sec.mdl", bone = "ValveBiped.Bip01_Spine4", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} , bonemerge = true, active = false },
	["foregrip"] = { type = "Model", model = "models/weapons/tfa_ins2_ar15wmpmc/upgrades/a_foregrip_sec.mdl", bone = "A_Foregrip", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0, 0, 0), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false},
...
SWEP.WElements = {
	...
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2_ar15wmpmc/upgrades/w_sil_sec1.mdl", bone = "ATTACH_Muzzle", rel = "ref", pos = Vector(-3, 0.1, 14), angle = Angle(0, 0, 0), size = Vector(0.699, 0.699, 0.699), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
