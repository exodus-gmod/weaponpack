...
SWEP.Type = "Shotgun"
SWEP.Purpose = " A fast firing, drum fed full auto shotgun. Comes with high modularity, unlike its alternatives."
...
SWEP.Primary.MaxFalloff         = 2.5 -- Maximal amount of damage to be lost
