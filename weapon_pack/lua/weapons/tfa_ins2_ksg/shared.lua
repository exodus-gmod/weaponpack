...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_INS2_KSG.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_INS2_KSG.2") -- This is the sound of the weapon, when silenced.
...
SWEP.Primary.RPM_Displayed = 300 -- This is in Rounds Per Minute / RPM
...
SWEP.Primary.MaxFalloff         = 4 -- Maximal amount of damage to be lost
--Penetration Related
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2/c_ksg.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2/w_ksg.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-3.13, -7.452, 0.55)
SWEP.IronSightsAng = Vector(-0.4, 0.015, 0)

SWEP.IronSightsPos_Kobra = Vector(-3.12, -7.452, 0.38)
SWEP.IronSightsAng_Kobra = Vector(0, 0, 0)

SWEP.IronSightsPos_EOTech = Vector(-3.12, -7.452, 0.141)
SWEP.IronSightsAng_EOTech = Vector(0, 0, 0)

SWEP.IronSightsPos_RDS = Vector(-3.12, -7.452, 0.14)
SWEP.IronSightsAng_RDS = Vector(0, 0, 0)

SWEP.IronSightsPos_2XRDS = Vector(-3.117, -8, 0.141)
SWEP.IronSightsAng_2XRDS = Vector(0.0, -0.0, 0)

SWEP.IronSightsPos_C79 = Vector(-3.12, -7.5, -0.28)
SWEP.IronSightsAng_C79 = Vector(0.0, -0.0, 0)

SWEP.IronSightsPos_PO4X = Vector(-3.043, -6.5, 0.265)
...
SWEP.StatusLengthOverride = {
	...
	[ACT_VM_RELOAD] = 0.2,
	["foregrip_reload"] = 0.2,
	[ACT_SHOTGUN_PUMP] = 10 / 30,
	[ACT_VM_PULLBACK] = 10 / 30,
	[ACT_VM_PULLBACK_LOW] = 10 / 30,
	[ACT_VM_PULLBACK_HIGH] = 10 / 30,
	[ACT_VM_DRYFIRE] = 0.5
...
SWEP.VElements = {
	["sights_folded"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_standard_ksg.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = true},
	...
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_suppressor_12ga.mdl", bone = "ValveBiped.Bip01_Spine4", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} , bonemerge = true, active = false },
	["foregrip"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_foregrip_sec.mdl", bone = "A_Foregrip", rel = "", pos = Vector(0, -0.3, 0), angle = Angle(0, 90, 0), size = Vector(0.6, 0.6, 0.6), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
...
SWEP.ScopeDistanceMin_2XRDS = 9.5
...
SWEP.ScopeDistanceMin_C79 = 9.75
