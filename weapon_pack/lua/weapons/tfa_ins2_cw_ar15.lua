...
SWEP.Author				= "Lucho" --Author Tooltip
SWEP.Contact				= "" --Contact Info Tooltip
SWEP.Purpose				= "A burst fire assault rifle. Highly modular, and comes with an optional UBGL." --Purpose Tooltip
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_INS2.CW_AR15.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_INS2.CW_AR15.2") -- This is the sound of the weapon, when silenced.
...
SWEP.Primary.RPM_Burst = 700 -- RPM for burst fire, overrides semi.  This is in Rounds Per Minute / RPM
...
SWEP.Primary.ClipSize_ExtRifle = 45 -- This is the size of a clip
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2/c_cw_ar15.mdl" --Viewmodel path
SWEP.ViewModel_EXT			= "models/weapons/tfa_ins2/c_cw_ar15_ext.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2/w_cw_ar15.mdl" -- Weapon world model path
SWEP.WorldModel_EXT			= "models/weapons/tfa_ins2/w_cw_ar15_ext.mdl" -- Weapon world model path
...
SWEP.ViewModelBoneMods = {
	...
	["A_Suppressor"] = { scale = Vector(1.1, 1.1, 1.1), pos = Vector(0, -8, -0.1), angle = Angle(0, 180, 0) },
	["A_LaserFlashlight"] = { scale = Vector(1, 1, 1), pos = Vector(0.2, 0, 0), angle = Angle(0, 0, 0) },
	["A_UnderBarrel"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
...
SWEP.WorldModelBoneMods = {
	["ATTACH_Muzzle"] = { scale = Vector(0.7, 0.7, 0.7), pos = Vector(8.3, -0.8, 0.4), angle = Angle(0, 180, 0) },
	["ATTACH_Laser"] = { scale = Vector(1, 1, 1), pos = Vector(-5, -0.8, -0.3), angle = Angle(0, 0, 0) },
	["ATTACH_Foregrip"] = { scale = Vector(.75, .75, .75), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["ATTACH_GL"] = { scale = Vector(.7, .7, .7), pos = Vector(-0.5, 0, 0), angle = Angle(0, 0, 0) },
}

SWEP.VElements = {
	["sights_folded"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/f_ar15_carryhandle.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = true, bonemerge = true },
	["sight_fsi"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/f_ar15_foldingsight.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
	["sight_kobra"] = { type = "Model", model = "models/weapons/upblitz/a_optic_kobra_lp.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
	["sight_kobra_lens"] = (TFA.INS2 and TFA.INS2.GetHoloSightReticle) and TFA.INS2.GetHoloSightReticle("sight_kobra") or nil,

	["sight_eotech"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_eotech.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(90, 90, 0), size = Vector(0.75, 0.9, 0.9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
	...
	["scope_c79"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_elcan.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(90, 0, 90), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
	
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_suppressor_ar15.mdl", bone = "A_Suppressor", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} , bonemerge = true, active = false },
	["basebarrel"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/f_ar15_m4barrel.mdl", bone = "Weapon", rel = "", pos = Vector(0, 0, 0.25), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = true},
	["magpulbarrel"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/f_ar15_m4moe.mdl", bone = "Weapon", rel = "", pos = Vector(0, 0, 0.25), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false},
	["m16barrel"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/f_ar15_m16barrel.mdl", bone = "Weapon", rel = "", pos = Vector(0, 0, 0.25), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false},
	["risbarrel"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/f_ar15_m4rail.mdl", bone = "Weapon", rel = "", pos = Vector(0, 0, 0.25), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false},
	["risextbarrel"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/f_ar15_m16rail.mdl", bone = "Weapon", rel = "", pos = Vector(0, 0, 0.25), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false},
	["foregrip"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_foregrip_sec.mdl", bone = "A_Foregrip", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false},
	["basestock"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/f_ar15_m4stock.mdl", bone = "Weapon", rel = "", pos = Vector(0, -0.9, 0.3), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = true},
	["magpulstock"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/f_ar15_m4moestock.mdl", bone = "Weapon", rel = "", pos = Vector(0, -0.9, 0.3), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false},
	["m16stock"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/f_ar15_m16stock.mdl", bone = "Weapon", rel = "", pos = Vector(0, -0.9, 0.3), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false},
	["gl"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/f_ar15_gl.mdl", bone = "A_Foregrip", rel = "", pos = Vector(0, -0.245, 0.159), angle = Angle(0, -90, 0), size = Vector(0.611, 0.611, 0.611), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false},	
	["mag"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/f_ar15_30rndmag.mdl", bone = "Magazine", rel = "", pos = Vector(0, -1.55, 25), angle = Angle(90, 0, 0), size = Vector(1, 0.9, 0.9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} , bonemerge = true, active = true },
	["mag_ext"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/f_ar15_60rndmag.mdl", bone = "Magazine", rel = "", pos = Vector(0, -1.55, 25), angle = Angle(90, 0, 0), size = Vector(1, 0.9, 0.9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} , bonemerge = true, active = false },
...
SWEP.WElements = {
	...
	["mag"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_ar15_30mag.mdl", bone = "ATTACH_Standard", rel = "ref", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = true},
	["mag_ext"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_ar15_60mag.mdl", bone = "ATTACH_Standard", rel = "ref", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false},
	["sights_folded"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_ar15_carry.mdl", bone = "ATTACH_Standard", rel = "ref", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = true},
	["sight_fsi"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_ar15_fold.mdl", bone = "ATTACH_Standard", rel = "ref", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false},
	...
	["gl"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_m203.mdl", bone = "ATTACH_GL", rel = "ref", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
	...
	["flashlight"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_laser_ins.mdl", bone = "ATTACH_Laser", rel = "ref", pos = Vector(0, 0, 0), angle = Angle(8, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },

}

SWEP.Attachments = {
	[1] = { offset = { 0, 0 }, atts = { "ins2_br_supp", "r6s_muzzle_2", "r6s_flashhider_2" }, order = 2 },
	[2] = { offset = { 0, 0 }, atts = { "am_match", "am_magnum", "am_gib" }, order = 8 },
	[3] = { offset = { 0, 0 }, atts = { "ins2_br_heavy", "ins2_br_light"  }, order = 3 },
	[4] = { offset = { 0, 0 }, atts = { "ar15_si_folded", "ins2_si_kobra", "ins2_si_eotech", "ins2_si_rds", "ins2_si_2xrds", "ins2_si_c79" }, order = 1 },
	[5] = { offset = { 0, 0 }, atts = { "ins2_fg_grip" }, order = 5 },
	[6] = { offset = { 0, 0 }, atts = { "ar15_magpul_stock", "ar15_m16_stock" }, order = 7 },
	[7] = { offset = { 0, 0 }, atts = { "ins2_ub_flashlight1" }, order = 6 },
	[8] = { offset = { 0, 0 }, atts = { "ar15_magpul_barrel", "ar15_m16_barrel", "ar15_ris_barrel", "ar15_ext_ris_barrel" }, order = 4 }
}

SWEP.AttachmentDependencies = {	["ins2_ub_flashlight1"] = { "ar15_ris_barrel", "ar15_ext_ris_barrel" }, ["ins2_fg_m203"] = { "ar15_ris_barrel", "ar15_ext_ris_barrel" }, ["ins2_ub_laser"] = { "ar15_ris_barrel", "ar15_ext_ris_barrel" }	}--{["si_acog"] = {"bg_rail"}}
SWEP.AttachmentExclusions = { ["ins2_ub_flashlight1"] = {"ar15_magpul_barrel", "ar15_m16_barrel"}, ["ins2_fg_m203"] = {"ar15_magpul_barrel", "ar15_m16_barrel"},  ["ins2_ub_laser"] = {"ar15_magpul_barrel", "ar15_m16_barrel"} }
...
function SWEP:Think2(...)
    ...
    if self.Owner:KeyPressed(IN_ZOOM) and self:GetIronSights() then 
        if self.CurrentSightState == 1 then 
			...
			self.IronSightsPos_1P87 = Vector(-3.07, -2.1, 1.45)
			self.IronSightsAng_1P87 = Vector(0, 0, 0)
			self.IronSightsPos = Vector(-2.74, -1.293, 0.85)
			self.IronSightsAng = Vector(0.5, 0.05, 0)
			self.IronSightsPos_Kobra = Vector(-2.73, -2, 1.1)
			self.IronSightsAng_Kobra = Vector(0, 0, 0)
			self.IronSightsPos_EOTech = Vector(-2.73, -0.3, 0.87)
			self.IronSightsAng_EOTech = Vector(0, 0, 0)
			self.IronSightsPos_RDS = Vector(-2.735, -0.293, 0.86)
			self.IronSightsAng_RDS = Vector(0, 0, 0)
			self.IronSightsPos_2XRDS = Vector(-2.731, -2.993, 0.865)
			self.IronSightsAng_2XRDS = Vector(0, 0, 0)
			self.IronSightsPos_C79 = Vector(-2.737, -3.5, 0.68)
			self.IronSightsAng_C79 = Vector(0, 0, 0)
			self.IronSightsPos_PO4X = Vector(-3, -3, 1.09)
			self.IronSightsAng_PO4X = Vector(0, 0, 0)
			self.IronSightsPos_MX4 = Vector(-3.075, -3, 0.67)
			self.IronSightsAng_MX4  = Vector(0, 0, -0.7)
