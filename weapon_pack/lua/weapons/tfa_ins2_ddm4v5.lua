...
SWEP.Manufacturer 			= "Daniel Defense, United States" --Gun Manufactrer (e.g. Hoeckler and Koch )
SWEP.Author				= "YukiZ - Edit by Lucho" --Author Tooltip
SWEP.Contact				= "" --Contact Info Tooltip
SWEP.Purpose				= "A modified AR platform assault rifle. Built for personal defense and V.I.P protection." --Purpose Tooltip
SWEP.Description				= "A Lighter, Stronger, Better Rifle" --Purpose Tooltip
...
SWEP.PrintName				= "DDM4V5"		-- Weapon name (Shown on HUD)
SWEP.Slot				= 2			-- Slot in the weapon selection menu.  Subtract 1, as this starts at 0.
SWEP.SlotPos				= 1			-- Position in the slot
SWEP.AutoSwitchTo			= false -- Auto switch to if we pick it up
SWEP.AutoSwitchFrom			= false -- Auto switch from if you pick up a better weapon
SWEP.Weight				= 30			-- This controls how "good" the weapon is for autopickup.
SWEP.Type 				= "Long Barrel AR15 For Better Looking And Devastation"

--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_INS2.DDM4V5.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_INS2.DDM4V5.2") -- This is the sound of the weapon, when silenced.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/v_ddm4v5.mdl" --Viewmodel path
SWEP.ViewModelFOV			= 70		-- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip			= false		-- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands = true --Use gmod c_arms system.
SWEP.VMPos = Vector(0, 0, -0.25) --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/w_ddm4v5.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(2.5, -1.6, 0)
...
--[[INSPECTION]]--
SWEP.InspectPos = Vector(10, -3.5, 1)
SWEP.InspectAng = Vector(36.34, 55, 39.937)
...
SWEP.StatusLengthOverride = {
	["base_reload"] = 75 / 30,
	["base_reload_empty"] = 78 / 30,
	["foregrip_reload"] = 75 / 30,
	["foregrip_reload_empty"] = 78 / 30,
                ["gl_reload"] = 72 / 30,
	["gl_reload_empty"] = 55 / 30,
	["glsetup_reload"] = 54 / 31,
...
SWEP.SprintAnimation = {
	["loop"] = {
		["type"] = TFA.Enum.ANIMATION_SEQ, --Sequence or act
		["value"] = "ACT_VM_SPRINT", --Number for act, String/Number for sequence
		["is_idle"] = true,
}
}
--[[EFFECTS]]--
...
SWEP.ViewModelBoneMods = {
	["A_Suppressor"] = { scale = Vector(0.8, 0.8, 0.8), pos = Vector(0, 0, -1), angle = Angle(0, 0, 0) },
        ["A_Optic"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, 0, -0) },
	["A_Underbarrel"] = { scale = Vector(1, 1, 1), pos = Vector(0, -1, 0), angle = Angle(0, 0, 0) },
	["A_Foregrip"] = { scale = Vector(0.4, 0.4, 0.4), pos = Vector(0, -0, 0.25), angle = Angle(0, 0, 0) },
        --["A_GL"] = { scale = Vector(0.8, 0.8, 0.8), pos = Vector(-0.1, 0, 0), angle = Angle(0, 0, 0) },
                ["A_M320"] = { scale = Vector(0.8, 0.8, 0.8), pos = Vector(-0.1, 0, 0), angle = Angle(0, 0, 0) },
                ["M320_Tube"] = { scale = Vector(0.8, 0.8, 0.8), pos = Vector(-0.1, -0.5, 0), angle = Angle(0, 0, 0) },
        ["A_Laserflashlight"] = { scale = Vector(0.95, 0.95, 0.95), pos = Vector(-0.1, 0, -1), angle = Angle(0, 0, 0) }, 
}
...
SWEP.WorldModelBoneMods = {
	...
	["ATTACH_Foregrip"] = { scale = Vector(0.7, 0.7, 0.7), pos = Vector(2, 0, -0.5), angle = Angle(0, 0, 0) },
        ["ATTACH_GL"] = { scale = Vector(0.8, 0.8, 0.8), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) }, 
}

SWEP.VElements = {
        ["sights_folded"] = { type = "Model", model = "models/weapons/upgrades/ddm4v5/a_carryhandle_ddm4v5.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = true, bonemerge = true },
	...
	["scope_c79"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_elcan_m.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.4, 0.4, 0.4), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
	...
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_suppressor_sec2.mdl", bone = "A_Suppressor", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} , bonemerge = true, active = false },
                ["foregrip"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_foregrip_ins2.mdl", bone = "", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 90, 0), size = Vector(0.485, 0.485, 0.485), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
                ["gl"] = { type = "Model", model = "models/weapons/upgrades/ddm4v5/a_gl_m320.mdl", bone = "A_GL", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.75, 0.75, 0.75), color = color_white, surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false},
	["laser"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_laser_anpeq15.mdl", bone = "A_LaserFlashlight", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
	...
	["flashlight"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_laser_anpeq15.mdl", bone = "A_LaserFlashlight", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, -0), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },

	["sight_rmr_canted"] = { type = "Model", model = "models/weapons/tfa_eft/upgrades/sights/reflex/v_canted_rmr.mdl", bone = "A_Optic", rel = "", pos = Vector(0.05, 0, 2.1), angle = Angle(90, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
...
SWEP.WElements = {
        ["sights_folded"] = { type = "Model", model = "models/weapons/upgrades/ddm4v5/w_flipupv5.mdl", bone = "ATTACH_ModKit", rel = "", pos = Vector(0, 0,0), angle = Angle(0, 0, 0), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = true},
	...
	["scope_c79"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_elcan.mdl", bone = "ATTACH_ModKit", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
	...
	["laser"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_laser_ins.mdl", bone = "ATTACH_Laser", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
                ["gl"] = { type = "Model", model = "models/weapons/upgrades/ddm4v5/w_gl_m320.mdl", bone = "ATTACH_GL", rel = "ref", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
}
...
SWEP.Attachments = {
	...
	[3] = { offset = { 0, 0 }, atts = { "am_match", "am_magnum", "am_gib" }, order = 6 },
	...
	[8] = { offset = { 0, 0 }, atts = { "ins2_fg_grip"}, order = 4 },
                [9] = { offset = { 0, 0 }, atts = { "ins2_ub_laser", "ins2_ub_flashlight2"}, order = 5 },
}
...
function SWEP:Think2(...)
    ...
    if self.Owner:KeyPressed(IN_ZOOM) and self:GetIronSights() then 
        if self.CurrentSightState == 1 then 
			...
			self.IronSightsPos = Vector(-2.625, -2, -0.3)
			self.IronSightsAng = Vector(0.0, 0, 0)
			self.IronSightsPos_Kobra = Vector(-2.635, -2, -0.145)
			self.IronSightsAng_Kobra = Vector(0, 0, 0)
			self.IronSightsPos_EOTech = Vector(-2.63, -2, -0.174)
			self.IronSightsAng_EOTech = Vector(0, 0, 0)
			self.IronSightsPos_RDS = Vector(-2.63, -2, -0.4)
			self.IronSightsAng_RDS = Vector(0, 0, 0)
			self.IronSightsPos_2XRDS = Vector(-2.625, -2, -0.178)
			self.IronSightsAng_2XRDS = Vector(0, 0, 0)
			self.IronSightsPos_C79 = Vector(-2.63, -1.5, -0.52)
