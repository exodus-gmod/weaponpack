...
SWEP.Type                   = ( TFA and TFA.Yankys_Custom_Weapon_Pack ) and "Type: Submachine Gun - Caliber: 9x19mm - Muzzle Velocity: 400 m/s" or "Submachine Gun"
...
SWEP.Primary.Sound          = Sound("TFA_INS2.Warface_BT_MP9.Fire")            -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound  = Sound("TFA_INS2.Warface_BT_MP9.Fire_Suppressed") -- This is the sound of the weapon, when silenced.
...
SWEP.ViewModel	    = "models/weapons/c_ins2_warface_bt_mp9.mdl"
SWEP.VMPos          = ( TFA and TFA.Yankys_Custom_Weapon_Pack ) and Vector(-1.15, 0, 0.65) or Vector(-0.2, 0, 0.5)
...
SWEP.WorldModel	  = "models/weapons/w_ins2_warface_bt_mp9.mdl" -- Weapon world model path
...
SWEP.IronSightsPos        = Vector(-2.665, -1.5, 1.73)
SWEP.IronSightsAng        = Vector(0.22, 0.055, 0)

SWEP.IronSightsPos_Point_Shooting = Vector(-4.5, -2, -1)
SWEP.IronSightsAng_Point_Shooting = Vector(0, 0, -30)
SWEP.Secondary.Point_Shooting_FOV = 65

SWEP.IronSightsPos_Kobra  = Vector(-2.67, -1.5, 0.9)
SWEP.IronSightsAng_Kobra  = Vector(0, -0.02, 0)

SWEP.IronSightsPos_RDS    = Vector(-2.645, -1.5, 0.75)
SWEP.IronSightsAng_RDS    = Vector(0, 0.03 ,0)

SWEP.IronSightsPos_EOTech = Vector(-2.67, -1.5, 0.7)
SWEP.IronSightsAng_EOTech = Vector(0, 0, 0)

SWEP.IronSightsPos_2XRDS  = Vector(-2.65, -3.5, 0.68)
SWEP.IronSightsAng_2XRDS  = Vector(0, 0, 0)
SWEP.RTOverlayTransforms_2XRDS = { 0, -0 }
SWEP.Secondary.IronFOV_2XRDS = 65
SWEP.RTScopeFOV_2XRDS        = 30

SWEP.IronSightsPos_C79    =  Vector(-2.654, -3.5, 0.565)
...
SWEP.InspectPos   = Vector(6, -2, 0.35)
...
SWEP.ViewModelBoneMods = {
	...
	["A_Optic"] = { scale = Vector(0.9, 0.9, 0.9), pos = Vector(0, -0.5, 0), angle = Angle(0, 0, 0) },
	["A_Suppressor"] = { scale = Vector(0.85, 0.85, 0.85), pos = Vector(0, 1.5, 0.5), angle = Angle(0, 0, 0) },
	["A_LaserFlashlight"] = { scale = Vector(0.8, 0.8, 0.8), pos = Vector(-0.85, 1, 1.2), angle = Angle(0, 0, 0) },
	["b_wpn_mag"] = { scale = Vector(1, 1, 1), pos = Vector(-0.02, 0, 0), angle = Angle(0, 0, 0) },
	...
	["b_ch_r_finger_30"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["b_ch_r_finger_31"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["b_ch_r_finger_32"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
...
--	["rail_sights"] = { type = "Model", model = "models/weapons/upgrades/a_modkit_kv_04.mdl", bone = "", rel = "", pos = Vector(0, -0.245, 0.159), angle = Angle(0, -90, 0), size = Vector(0.611, 0.611, 0.611), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false},
	...
	["sight_rds"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_aimpoint.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(90, 0, 90), size = Vector(0.85, 0.85, 0.85), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
...
--	["foregrip"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_foregrip_ins2.mdl", bone = "A_Foregrips", rel = "", pos = Vector(0, -0.035, -0.8), angle = Angle(0, 90, 0), size = Vector(0.5, 0.5, 0.5), color = color_white, surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_suppressor_sec.mdl", bone = "A_Suppressor", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} , bonemerge = true, active = false },
	["suppressor_aac"] = { type = "Model", model = "models/weapons/tfa_eft/upgrades/v_aac.mdl", bone = "A_Suppressor", rel = "", pos = Vector(0, 0, 0.012), angle = Angle(0, 0, 0), size = Vector(1.65, 1.5, 1.65), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = false, active = false, bodygroup = {} },
	["suppressor_osprey"] = { type = "Model", model = "models/weapons/tfa_eft/upgrades/v_osprey.mdl", bone = "A_Suppressor", rel = "", pos = Vector(0, -0.1, 0), angle = Angle(0, 0, 0), size = Vector(1.3, 1.3, 1.3), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} , bonemerge = false, active = false },
	["laser"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_laser_rail.mdl", bone = "A_LaserFlashlight", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1 ,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
	...
	["laser_beam_anpeq15_tan"] = { type = "Model", model = "models/tfa/lbeam.mdl", bone = "A_Stream", rel = "laser_anpeq15_black", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(2, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
	["flashlight"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_flashlight_rail.mdl", bone = "A_LaserFlashlight", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 180), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
	["flashlight_lastac"] = { type = "Model", model = "models/weapons/tfa_eft/upgrades/v_lastac.mdl", bone = "A_LaserFlashlight", rel = "", pos = Vector(0, -0.28, -0.05), angle = Angle(-90, -90, 0), size = Vector(0.85, 0.85, 0.85), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = false, active = false, bodygroup = {} },
}
...
function SWEP:Think2(...)
    ...
    if self.Owner:KeyPressed(IN_ZOOM) and self:GetIronSights() then 
        if self.CurrentSightState == 1 then 
			...
			self.IronSightsPos = Vector(-2.665, -1.5, 1.73)
			self.IronSightsAng = Vector(0.22, 0.055, 0)
			self.IronSightsPos_Kobra = Vector(-2.67, -1.5, 0.9)
			self.IronSightsAng_Kobra = Vector(0, -0.02, 0)
			self.IronSightsPos_EOTech = Vector(-2.67, -1.5, 0.7)
			self.IronSightsAng_EOTech = Vector(0, 0, 0)
			self.IronSightsPos_RDS = Vector(-2.645, -1.5, 0.75)
			self.IronSightsAng_RDS = Vector(0, 0.03 ,0)
			self.IronSightsPos_2XRDS = Vector(-2.65, -3.5, 0.68)
			self.IronSightsAng_2XRDS = Vector(0, 0, 0)
			self.IronSightsPos_C79 = Vector(-2.654, -3.5, 0.565)
