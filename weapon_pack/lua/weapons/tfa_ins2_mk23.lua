...
SWEP.Purpose				= "A modified USP pistol with a laser sight pre attached." --Purpose Tooltip
...
SWEP.PrintName				= "MK 23"		-- Weapon name (Shown on HUD)
...
--[[SAFETY]]--
SWEP.SafetyPos = Vector(1.25, -9, -10)
...
SWEP.WElements = {
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_suppressor_mk23.mdl", bone = "", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = true, active = false, bodygroup = {} },
}
...
SWEP.AttachmentTableOverride = {
	["ins2_br_supp"] = {
		["WepSelectIcon_Override"] = "vgui/hud/tfa_ins2_mk23_silenced"
	}
}
