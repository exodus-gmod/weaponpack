...
SWEP.Purpose				= "A classic russian DMR. Chambered in an intermediate cartridge, but its heavy barrel improves muzzle velocity." --Purpose Tooltip
...
--Recoil Related
SWEP.Primary.KickUp = 0.435 -- This is the maximum upwards recoil (rise)
...
SWEP.Attachments = {
	...
	[3] = { offset = { 0, 0 }, atts = { "am_match_dmr", "am_magnum", "am_gib_dmr" }, order = 6 },
