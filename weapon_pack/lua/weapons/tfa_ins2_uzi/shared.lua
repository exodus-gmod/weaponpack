...
SWEP.Purpose				= "A pistol caliber PDW. Fires slow, but has easy recoil." --Purpose Tooltip
SWEP.Instructions				= "" --Instructions Tooltip
SWEP.Spawnable				= true --Can you, as a normal user, spawn this?
SWEP.AdminSpawnable			= true --Can an adminstrator spawn this?  Does not tie into your admin mod necessarily, unless its coded to allow for GMod's default ranks somewhere in its code.  Evolve and ULX should work, but try to use weapon restriction rather than these.
SWEP.DrawCrosshair			= true		-- Draw the crosshair?
SWEP.DrawCrosshairIS = false --Draw the crosshair in ironsights?
SWEP.PrintName				= "IMI UZI"		-- Weapon name (Shown on HUD)
SWEP.Slot				= 2			-- Slot in the weapon selection menu.  Subtract 1, as this starts at 0.
SWEP.SlotPos				= 1			-- Position in the slot
SWEP.AutoSwitchTo			= false -- Auto switch to if we pick it up
SWEP.AutoSwitchFrom			= false -- Auto switch from if you pick up a better weapon
SWEP.Weight				= 26			-- This controls how "good" the weapon is for autopickup.
SWEP.Type = "Israeli 9x19mm Automatic Sub Machine Gun"

--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_INS2_UZI.1")
SWEP.Primary.SilencedSound = Sound("TFA_INS2_UZI.2")
SWEP.Primary.PenetrationMultiplier = 20 --Change the amount of something this gun can penetrate through
...
--Recoil Related
SWEP.Primary.KickUp = 0.144 -- This is the maximum upwards recoil (rise)
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2/v_uzi.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2/w_uzi.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-2.378, -1.5, 0.8)
SWEP.IronSightsAng = Vector(0, 0.01, 0)

--[[INSPECTION]]--
SWEP.InspectPos = Vector(3.5, -1, -1.9)
SWEP.InspectAng = Vector(20, 30, 5)
...
SWEP.ViewModelBoneMods = {
	...
	["A_Modkit"] = { scale = Vector(0.88, 0.88, 0.88), pos = Vector(0, -0.4, 0), angle = Angle(0, 0, 0) },
	["A_Suppressor"] = { scale = Vector(1.2, 1.1, 1.2), pos = Vector(0, 1, 0), angle = Angle(0, 0, 0) },
	["A_LaserFlashlight"] = { scale = Vector(0.9, 0.9, 0.9), pos = Vector(-0.1, 0.2, 0), angle = Angle(0, 0, 0) },
}

SWEP.WorldModelBoneMods = {
	["ATTACH_Muzzle"] = { scale = Vector(1.45, 1.4, 1.3), pos = Vector(-0.75, 0, 0.9), angle = Angle(0, 0, 0) },
	["ATTACH_Laser"] = { scale = Vector(1.2, 1.2, 1.2), pos = Vector(0, -0.5, 1), angle = Angle(0, 0, 270) },
}
...
SWEP.Attachments = {
[1] = { offset = { 0, 0 }, atts = { "ins2_br_supp", "r6s_muzzle_2", "r6s_flashhider_2", "ins2_br_boost" }, order = 1 },
