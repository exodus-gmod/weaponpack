...
SWEP.Purpose				= "A modern pistol. Used and favored by the U.S military for many years. Has a solid capacity." --Purpose Tooltip
...
SWEP.PrintName				= "Beretta M9"		-- Weapon name (Shown on HUD)
...
--Recoil Related
SWEP.Primary.KickUp = 0.241 -- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown = 0 -- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal = 0.097 -- This is the maximum sideways recoil (no real term)
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2/c_beretta.mdl" --Viewmodel path
...
--[[SAFETY]]--
SWEP.SafetyPos = Vector(1.25, -10, -10)
...
SWEP.IronSightsPos = Vector(-2.2, 0, 0.425)
SWEP.IronSightsAng = Vector(-0.058, 0, 0)

SWEP.IronSightsPos_RMR = Vector( -2.2489, 0.28, 0.075)
...
SWEP.VElements = {
	...
	["sight_rmr"] = { type = "Model", model = "models/weapons/tfa_eft/upgrades/v_rmr.mdl", bone = "Slide", rel = "", pos = Vector(-0.01835, -2.1, 0.7), angle = Angle(0, 180, 0), size = Vector(0.85, 0.95, 0.95), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = false, active = false, bodygroup = {} },
				["sight_rmr_lens"] = (TFA.EFTC and TFA.EFTC.GetHoloSightReticle) and TFA.EFTC.GetHoloSightReticle("sight_rmr") or nil,
}

SWEP.WElements = {
	["ref"] = { type = "Model", model = SWEP.WorldModel, bone = "oof", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = true },
