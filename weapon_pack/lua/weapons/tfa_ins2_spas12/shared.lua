...
SWEP.Purpose				= "A rapid fire pump action shotgun using 12 gauge ammunition." --Purpose Tooltip
...
SWEP.RunSightsAng = Vector(-10, 15, -10) --Change this, using SWEP Creation Kit preferably
--[[IRONSIGHTS]]--
SWEP.data = {}
...
SWEP.Attachments = {
	...
	[2] = { offset = { 0, 0 }, atts = { "sg_slug" }, order = 3 },
