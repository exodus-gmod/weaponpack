...
SWEP.Type                   = ( TFA and TFA.Yankys_Custom_Weapon_Pack ) and "Type: Assault Rifle - Caliber: 7.62x39mm - Muzzle Velocity: 750 m/s" or "Assault Rifle"

--[[WEAPON HANDLING]]--

SWEP.Primary.Sound          = Sound("TFA_INS2.AK103.Fire")            -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound  = Sound("TFA_INS2.AK103.Fire_Suppressed") -- This is the sound of the weapon, when silenced.
SWEP.Primary.GLSound        = Sound("TFA_INS2_GP30.1")                -- This is the sound of the grenade launcher, when you shoot.

SWEP.Primary.SoundEchoTable = {
	[0]   = Sound("TFA_MWR_ASL.TailInside"), 
	[256] = Sound("TFA_MWR_AK47.TailOutside") 
}
...
SWEP.MuzzleFlashEffect          = ( TFA and TFA.YanKys_Realistic_Muzzleflashes ) and "tfa_muzzleflash_ak103" or "tfa_muzzleflash_rifle"           
...
SWEP.ViewModel	         = "models/weapons/c_ins2_rif_ak103.mdl"
SWEP.VMPos               = ( TFA and TFA.Yankys_Custom_Weapon_Pack ) and Vector(-0.8, 0, 0.25) or Vector(-0.35, 0, 0.15)
...
SWEP.WorldModel	  = "models/weapons/w_ins2_rif_ak103.mdl"           -- Weapon world model path
...
SWEP.IronSightsPos     = Vector(-2.915, -2, 1.1)
SWEP.IronSightsAng     = Vector(-0.15, 0.02, 0)

SWEP.IronSightsPos_Point_Shooting = Vector(-5, -3, -1)
SWEP.IronSightsAng_Point_Shooting = Vector(0, 0, -30)
SWEP.Secondary.Point_Shooting_FOV = 65


SWEP.IronSightsPos_1P87 = Vector(-3.4685, -4, -0.178)
SWEP.IronSightsAng_1P87 = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_1P87 = 65

SWEP.IronSightsPos_GL     = Vector(-1.35, -4.5, 1.1)
SWEP.IronSightsAng_GL     = Vector(1.05,-0.01,0)

SWEP.IronSightsPos_Kobra  = Vector(-2.92, -1, -0.35)
SWEP.IronSightsAng_Kobra  = Vector(0, -0.012, 0)

SWEP.IronSightsPos_RDS    = Vector(-2.9, 0, -0.85)
SWEP.IronSightsAng_RDS    = Vector(0.28, 0.065, 0)

SWEP.IronSightsPos_EOTech = Vector(-2.91, -1.0, -0.59)
SWEP.IronSightsAng_EOTech = Vector(0.125, -0.012, 0)

SWEP.IronSightsPos_2XRDS  = Vector(-2.9, -1.25, -0.55)
SWEP.IronSightsAng_2XRDS  = Vector(0, 0, 0)
SWEP.RTScopeFOV_2XRDS     = 35

SWEP.IronSightsPos_C79    =  Vector(-2.903, -2, -0.65)
SWEP.IronSightsAng_C79    = Vector(0, 0, 0)
SWEP.RTScopeFOV_C79       = 45

SWEP.IronSightsPos_PO4X   = Vector(-2.845, -3, -0.27)
SWEP.IronSightsAng_PO4X   = Vector(0, 0, 0)
SWEP.RTScopeFOV_PO4X      = 40

SWEP.IronSightsPos_MX4       = Vector(-2.92, 0, -0.675)
SWEP.IronSightsAng_MX4       = Vector(0, 0, 0)
SWEP.RTOverlayTransforms_MX4 = { -0.005, -0 }
...
SWEP.InspectPos   = Vector(6, -1.25, -0.3)
...
SWEP.Attachments = {
	...
	[2] = { atts = { "r6s_muzzle_2", "r6s_flashhider_2", "ins2_br_supp" }, order = 2},
	[3] = { atts = { "ins2_ub_laser", "ins2_ub_flashlight1" }},
	[4] = { atts = { "ins2_fg_grip" }, order = 4 },
	[8] = { atts = { "am_match", "am_magnum", "am_gib" }, order = 5 },
	[9] = { offset = { 0, 0 }, atts = { "ins2_br_heavy", "ins2_br_light"  }, order = 3 },
}
...
SWEP.ViewModelBoneMods = {
	...
	["A_Modkit"] = { scale = Vector(1.2, 1.2, 1.4), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
--	["ValveBiped.Bip01_L_Finger0"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, 0, 10) },
	["A_Optic"] = { scale = Vector(0.85, 0.85, 0.85), pos = Vector(0, 0.75, 0), angle = Angle(0, 0, 0) },
...
SWEP.WorldModelBoneMods = {
	["ATTACH_Muzzle"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, 0, 90) },
	["ATTACH_ModKit"] = { scale = Vector(1, 1, 1), pos = Vector(0.55, 0, -0.1), angle = Angle(0, 0, 0) },
	["ATTACH_Laser"] = { scale = Vector(1, 1, 1), pos = Vector(1, 0, 1), angle = Angle(0, 0, -90) },
...
SWEP.VElements = {
	...
	["sight_rds"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_aimpoint.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, -1), angle = Angle(90, 0, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
	...
	["scope_mx4"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_m40_l.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(90, 90, 0), size = Vector(.85, 0.85, 0.85), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true},
 
	["suppressor"] = { type = "Model", model = "models/weapons/upgrades/a_suppressor_pbs1.mdl", bone = "A_Suppressor", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} , bonemerge = true, active = false },
	...
	["gl"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_gl_gp25.mdl", bone = "A_GL", rel = "", pos = Vector(0, -0.245, 0.159), angle = Angle(0, -90, 0), size = Vector(0.611, 0.611, 0.611), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false},

	["laser"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_laser_anpeq15_band.mdl", bone = "A_LaserFlashlight", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1 ,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
	...
	["flashlight"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_laser_anpeq15_band.mdl", bone = "A_LaserFlashlight", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 180), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },

	["sight_rmr_canted"] = { type = "Model", model = "models/weapons/tfa_eft/upgrades/sights/reflex/v_canted_rmr.mdl", bone = "A_Optic", rel = "", pos = Vector(0.1, 0, 1.), angle = Angle(90, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
	...
	["sight_1p87"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_1p87.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
--	["sight_1p87_lens"] = {type = "Quad", rel = "sight_1p87", bone = "A_RenderReticle", pos = Vector(4, 0, 0), angle = Angle(90, 0, 0), size = 0.25, draw_func_outer = drawFuncUni(), active = false},
...
function SWEP:Think2(...)
    ...
    if self.Owner:KeyPressed(IN_ZOOM) and self:GetIronSights() then 
        if self.CurrentSightState == 1 then 
			...
			self.IronSightsPos = Vector(-2.915, -2, 1.1)
			self.IronSightsAng = Vector(-0.15, 0.02, 0)
			self.IronSightsPos_Kobra = Vector(-2.92, -1, -0.35)
			self.IronSightsAng_Kobra = Vector(0, -0.012, 0)
			self.IronSightsPos_EOTech = Vector(-2.91, -1.0, -0.59)
			self.IronSightsAng_EOTech = Vector(0.125, -0.012, 0)
			self.IronSightsPos_RDS = Vector(-2.9, 0, -0.85)
			self.IronSightsAng_RDS = Vector(0.28, 0.065, 0)
			self.IronSightsPos_2XRDS = Vector(-2.9, -1.25, -0.55)
			self.IronSightsAng_2XRDS = Vector(0, 0, 0)
			self.IronSightsPos_C79 = Vector(-2.903, -2, -0.65)
			self.IronSightsAng_C79 = Vector(0, 0, 0)
			self.IronSightsPos_PO4X = Vector(-2.845, -3, -0.27)
			self.IronSightsAng_PO4X = Vector(0, 0, 0)
			self.IronSightsPos_MX4 = Vector(-2.92, 0, -0.675)
