...
-- Recoil Related
SWEP.Primary.KickUp              = 0.161                        -- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown            = 0                        -- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal      = 0.094                        -- This is the maximum sideways recoil (no real term)
...
SWEP.Attachments = {
	[1] = { atts = { "ins2_si_kobra", "ins2_si_eotech", "ins2_si_rds", "ins2_si_2xrds", "ins2_si_c79", "ins2_si_po4x", "ins2_si_c", "ins2_si_mx4" }, order = 1},
	[2] = { atts = { "r6s_muzzle_2", "r6s_flashhider_2", "bo2_longbarrel", "ins2_br_supp", "ins2_eft_osprey" }, order = 2},
	[3] = { atts = { "ins2_ub_laser", "ins2_laser_anpeq15_black", "ins2_laser_anpeq15_tan", "ins2_ub_flashlight1" }},
	[4] = { atts = { "ins2_fg_grip" }, order = 4 },
	[8] = { atts = { "am_match", "am_magnum", "am_gib", "tfa_mb_penrnd" }, order = 5 },
