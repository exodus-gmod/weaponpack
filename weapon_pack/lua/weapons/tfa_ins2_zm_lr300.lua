...
SWEP.Manufacturer = "Z-M Weapons" --Gun Manufactrer (e.g. Hoeckler and Koch )
SWEP.Author				= "Cluelesshobo" --Author Tooltip
SWEP.Contact				= "" --Contact Info Tooltip
SWEP.Purpose				= "A rapidly firing lightweight carbine, excellent in CQC combat." --Purpose Tooltip
SWEP.Instructions				= "" --Instructions Tooltip
SWEP.Spawnable				= true 
SWEP.AdminSpawnable			= true --Can an adminstrator spawn this?  Does not tie into your admin mod necessarily, unless its coded to allow for GMod's default ranks somewhere in its code.  Evolve and ULX should work, but try to use weapon restriction rather than these.
SWEP.DrawCrosshair			= true		-- Draw the crosshair?
SWEP.DrawCrosshairIS = false --Draw the crosshair in ironsights?
SWEP.PrintName				= "LR 300-ML-N"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("Weapon_ZM_LR300.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("Weapon_ZM_LR300.2") -- This is the sound of the weapon, when silenced.
...
--Miscelaneous Sounds
SWEP.IronInSound = Sound("Weapon_ZM_LR300.Handon") --Sound to play when ironsighting in?  nil for default
SWEP.IronOutSound = Sound("Weapon_ZM_LR300.Handoff") --Sound to play when ironsighting out?  nil for default
--Silencing
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2/zm_lr300/c_zm_lr300.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2/zm_lr300/w_zm_lr300.mdl" -- Weapon world model path
...
SWEP.WorldModelBoneMods = {
	...
	["ATTACH_Laser"] = { scale = Vector(1, 1, 1), pos = Vector(-4.5, 0.45, -1.5), angle = Angle(0, 180, 90) },
	["ATTACH_Foregrip"] = { scale = Vector(.75, .75, .75), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
}

SWEP.VElements = {
	["sights_folded"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_flipup_lr300.mdl", bone = "A_Optic", rel = "", pos = Vector(-2.530, 1.9, -9.7), angle = Angle(90.36, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = true},
	...
	["foregrip"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_foregrip_sec2.mdl", bone = "A_Foregrip", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 90, 0), size = Vector(0.485, 0.485, 0.485), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
...
SWEP.WElements = {
	...
	["sights_folded"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_flipup_lr300.mdl", bone = "ATTACH_Standard", rel = "ref", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = true},
	["sight_kobra"] = { type = "Model", model = "models/weapons/upblitz/w_kobra_lp.mdl", bone = "ATTACH_ModKit", rel = "ref", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
