...
SWEP.Author = "Darky - Edit by Lucho"
SWEP.Contact = ""
SWEP.Purpose = ""
SWEP.Instructions = ""
...
SWEP.IronSightsPos_EOTech = Vector(-6, -0, 4.2)
SWEP.IronSightsAng_EOTech = Vector(-4.45, -1.241, 8.677)
...
SWEP.Attachments = {
	[1] = {atts = {"darky_rust_gl_shotgun","darky_rust_gl_smoke","darky_rust_gl_flash"}},
	[2] = {atts = {"darky_rust_ms_holosight", "darky_rust_holo", "darky_rust_4x", "darky_rust_8x", "ins2_si_eotech"}},
...
SWEP.VElements = {
	...
	["sight_eotech"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_eotech.mdl", bone = "barrel", rel = "", pos = Vector(0, -1, 2.4), angle = Angle(90, 90, 180), size = Vector(1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
...
SWEP.WElements = {
	...
	["sight_eotech"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_eotech.mdl", bone = "barrel", rel = "w_offset", pos = Vector(-0, 17.5, 2.4), angle = Angle(90, 90, 180), size = Vector(0.9, 0.9, 0.9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false,  active = false },

	
	["8xscope"] = { type = "Model", model = "models/weapons/darky_m/rust/mod_8xScope.mdl", bone = "barrel", rel = "w_offset", pos = Vector(0.05, -2.4+1.8, 6.7-3), angle = Angle(180, 0, 180), size = Vector(1, 0.7, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = false, active = false, bodygroup = {} },
...
SWEP.Primary.Projectile = "rust_luchogaz"
SWEP.Primary.ProjectileModel = "models/weapons/darky_m/rust/gl_ammo.mdl"
SWEP.Primary.ProjectileVelocity = 1700
