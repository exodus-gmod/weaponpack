...
SWEP.Primary.Damage                = ( TFA and TFA.Yankys_Custom_Weapon_Pack ) and 1 * TFA.Yankys_Custom_Weapon_Pack.DamageMultiplier or 175
...
SWEP.Primary.KickHorizontal      = 0.48                       -- This is the maximum sideways recoil (no real term)
...
SWEP.IronSightsPos_C79        = Vector(-3.178, -2, 0.496)
...
SWEP.IronSightsPos_PO4X       = Vector(-3.116, -3.5, 0.93)
...
SWEP.IronSightsAng_MX4        = Vector(0, 0, -00.85)
...
SWEP.Attachments = {
	...
	[2] = { atts = { "r6s_muzzle_2", "r6s_flashhider_2", "bo2_longbarrel", "ins2_br_supp", "ins2_eft_osprey" } },
