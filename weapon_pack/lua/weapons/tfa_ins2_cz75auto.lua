...
SWEP.Purpose				= "The Full-Automatic version of the CZ-75B."  
SWEP.Instructions			= ""              

SWEP.Author				    = "XxyanKy700xX & YuRaNnNzZZ"       -- Author Tooltip
...
if TFA then
	TFA.AddFireSound("TFA_INS2.CZ75A.1", "weapons/tfa_ins2/cz75/fp.wav", true, ")")
end

--[[ WEAPON HANDLING ]]--

SWEP.Primary.Sound          = Sound("TFA_INS2.CZ75A.1")   -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound  = Sound("TFA_INS2.CZ75.2")   -- This is the sound of the weapon, when silenced.
...
SWEP.Primary.Velocity              = 385                        -- Bullet Velocity in m/s
...
SWEP.ViewModel		= "models/weapons/tfa_ins2/c_cz75a.mdl"    -- Viewmodel path

SWEP.VMPos          = ( TFA and TFA.Yankys_Custom_Weapon_Pack ) and Vector(-0.65, -0.15, -0.60) or Vector(-0.25, -0.15, -0.65)
SWEP.VMAng          = Vector(0.05, 0, 0)
...
SWEP.WorldModel	    = "models/weapons/tfa_ins2/w_cz75a.mdl"    -- Weapon world model path
...
SWEP.IronSightsPos  = Vector(-2.005, 0, 0.15)
SWEP.IronSightsAng  = Vector(0.295, -0.018, 0)

SWEP.IronSightsPos_RMR = Vector(-2.005, 0, 0)
SWEP.IronSightsAng_RMR = Vector(-0.25, -0.018, 0)

SWEP.IronSightsPos_Point_Shooting = Vector(-4.8, -2, -1)
...
SWEP.CrouchPos    = Vector(-2, -1.5, -1.5)
SWEP.CrouchAng    = Vector(0, 0, -20)

--[[ INSPECTION ]] --

SWEP.InspectPos     = Vector(9.78, -7.658, -2.241) 
...
SWEP.Attachments = {
	...
	[3] = { atts = { "ins2_br_heavy", "ins2_br_light" } },
	[4] = { atts = { "ins2_ub_laser_cz75a", "ins2_ub_flashlight_cz75a" }},
	[5] = { atts = { "am_match", "am_magnum", "am_gib", "tfa_mb_penrnd" } },
}

SWEP.AttachmentDependencies = {	
    ["tfa_tactical_point_shooting"] = {"ins2_ub_laser_cz75a", "ins2_ub_flashlight_cz75a"},
}
SWEP.AttachmentExclusions = {}

SWEP.ViewModelBoneMods = {
	["A_Suppressor"] = { scale = Vector(1, 1, 1), pos = Vector(0, -1, -0.05), angle = Angle(0, 0, 0) },
	["A_UnderBarrel"] = { scale = Vector(0.85, 1, 1), pos = Vector(0, 0.8, 0.7), angle = Angle(0, 0, 0) },
...
SWEP.WorldModelBoneMods = {
	["ATTACH_Muzzle"] = { scale = wmscale, pos = Vector(-0.25, 0, 0), angle = Angle(0, 0, 0) },
}

SWEP.VElements = {
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_suppressor_pistol.mdl", bone = "barrel", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = true, active = false, bodygroup = {} },

	["sight_rmr"] = { type = "Model", model = "models/weapons/tfa_eft/upgrades/v_rmr.mdl", bone = "Slide", rel = "", pos = Vector(0, -1.5, 0.7), angle = Angle(0, 180, 0), size = Vector(0.8, 0.9, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = false, active = false, bodygroup = {} },
	["sight_rmr_lens"] = (TFA.EFTC and TFA.EFTC.GetHoloSightReticle) and TFA.EFTC.GetHoloSightReticle("sight_rmr") or nil,

	["suppressor_osprey"] = { type = "Model", model = "models/weapons/tfa_eft/upgrades/v_osprey.mdl", bone = "A_Suppressor", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1.15, 1.15, 1.15), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = false, active = false, bodygroup = {} },
	["suppressor_aac"] = { type = "Model", model = "models/weapons/tfa_eft/upgrades/v_aac.mdl", bone = "A_Suppressor", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1.40, 1.4, 1.40), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = false, active = false, bodygroup = {} },

	["laser"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_laser_cz75a.mdl", bone = "", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.9, 0.9, 0.9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = true, active = false, bodygroup = {} },
	["laser_beam"] = { type = "Model", model = "models/tfa/lbeam.mdl", bone = "LaserPistol", rel = "laser", pos = Vector(0, 0, -0.7), angle = Angle(0, 0, 0), size = Vector(2, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = false, active = false, bodygroup = {} },
	["flashlight"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_laser_cz75a.mdl", bone = "", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.9, 0.9, 0.9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = true, active = false, bodygroup = {} },
}

SWEP.WElements = {
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_sil_pistol.mdl", bone = "", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bonemerge = true, active = false, bodygroup = {} },
...
--	["flashlight"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_laser_sec.mdl", bone = "ATTACH_Laser", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
}
