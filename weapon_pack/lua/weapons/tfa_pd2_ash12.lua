...
SWEP.Purpose				= "An intimidating 12.7mm russian battle rifle. Deals massive damage, but comes with a lot of kick." --Purpose Tooltip
...
SWEP.Primary.KickHorizontal = 0.158 -- This is the maximum sideways recoil (no real term)
...
SWEP.Attachments = {
	...
	[2] = { offset = { 0, 0 }, atts = { "ins2_si_kobra", "ins2_si_eotech", "ins2_si_rds", "ins2_si_2xrds", "ins2_si_c79", }, order = 1 },
