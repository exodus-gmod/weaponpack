...
SWEP.Manufacturer 			= "Heckler & Koch" --Gun Manufactrer
SWEP.Author					= "OLDMaster_24 - Edit by Lucho" --Author Tooltip
SWEP.Contact				= "" --Contact Info Tooltip
SWEP.Purpose				= "A fast firing 5.56 assault rifle. Especially useful for close encounters." --Purpose Tooltip
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_INS2.HK416.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_INS2.HK416.2") -- This is the sound of the weapon, when silenced.
SWEP.Primary.PenetrationMultiplier = 1 --Change the amount of something this gun can penetrate throughSWEP.Primary.Damage = 34 -- Damage, in standard damage points.
...
--Recoil Related
SWEP.Primary.KickUp = 0.132 -- This is the maximum upwards recoil (rise)
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2/v_hk416.mdl" --Viewmodel path
SWEP.ViewModelFOV			= 70		-- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip			= false		-- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands = true --Use gmod c_arms system.
SWEP.VMPos = Vector(0.5,-0.5,0.3) --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2/w_hk416.mdl" -- Weapon world model path
...
--[[INSPECTION]]--
SWEP.InspectPos = Vector(4.8, -2.211, -2.211)
SWEP.InspectAng = Vector(15.477, 24.622, 0)
...
SWEP.ViewModelBoneMods = {
	...
	["A_Optic"] = { scale = Vector(0.95, 0.95, 0.95), pos = Vector(0, -0.5, 0), angle = Angle(0, 0, 0) },
	["A_Suppressor"] = { scale = Vector(1, 1, 1), pos = Vector(0, 2, 0), angle = Angle(0, 0, 0) },
}

SWEP.WorldModelBoneMods = {
	["ATTACH_Foregrip"] = { scale = Vector(.75, .75, .75), pos = Vector(1, 2.2, -0.9), angle = Angle(10, 7, 0) },
	...
	["ATTACH_ModKit"] = { scale = Vector(.85, .85, .85), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
}

SWEP.VElements = {
    ["sights_folded"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_carryhandle_HK.mdl", bone = "A_Optic", rel = "", pos = Vector(0, -0.245, 0.159), angle = Angle(0, -90, 0), size = Vector(0.611, 0.611, 0.611), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = true},
	...
	["laser"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_laser_rail_1.mdl", bone = "A_LaserFlashlight", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 180), size = Vector(0.76, 0.76, 0.76), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
	...
	["sight_rmr_canted"] = { type = "Model", model = "models/weapons/tfa_eft/upgrades/sights/reflex/v_canted_rmr.mdl", bone = "A_Optic", rel = "", pos = Vector(0.05, 0, 0.5), angle = Angle(90, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
...
SWEP.WElements = {
    ["sights_folded"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_flipup_416.mdl", bone = "ATTACH_Standard", rel = "ref", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = true},
	...
	["laser"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_laser_ins.mdl", bone = "", rel = "ATTACH_Laser", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
	...
	["flashlight"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_laser_sec.mdl", bone = "ATTACH_Laser", rel = "", pos = Vector(0, 0, 12), angle = Angle(0, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
...
function SWEP:Think2(...)
    ...
    if self.Owner:KeyPressed(IN_ZOOM) and self:GetIronSights() then 
        if self.CurrentSightState == 1 then 
			...
			self.IronSightsPos = Vector(-2.49, 0, 0.7)
			self.IronSightsAng = Vector(0, 0, 0)
			self.IronSightsPos_Kobra = Vector(-2.49, 0, 0.825)
			self.IronSightsAng_Kobra = Vector(0, 0, 0)
			self.IronSightsPos_EOTech = Vector(-2.49, 0, 0.81)
			self.IronSightsAng_EOTech = Vector(0, 0, 0)
			self.IronSightsPos_RDS = Vector(-2.49, 0, 0.6)
			self.IronSightsAng_RDS = Vector(0, 0, 0)
			self.IronSightsPos_2XRDS = Vector(-2.4825, -2, 0.59)
			self.IronSightsAng_2XRDS = Vector(0, 0, 0)
			self.IronSightsPos_C79 = Vector(-2.487, -3, 0.475)
			self.IronSightsAng_C79 = Vector(0, 0, 0)
			self.IronSightsPos_PO4X = Vector(-2.422, -3, 0.91)
