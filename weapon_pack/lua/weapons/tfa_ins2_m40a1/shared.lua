...
SWEP.Category				= "EXR - Sniper Rifles" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
...
SWEP.Purpose				= "A high powered bolt action sniper rifle with an internal magazine." --Purpose Tooltip
SWEP.Instructions				= "" --Instructions Tooltip
SWEP.Spawnable				= true --Can you, as a normal user, spawn this?
SWEP.AdminSpawnable			= true --Can an adminstrator spawn this?  Does not tie into your admin mod necessarily, unless its coded to allow for GMod's default ranks somewhere in its code.  Evolve and ULX should work, but try to use weapon restriction rather than these.
SWEP.DrawCrosshair			= true		-- Draw the crosshair?
SWEP.DrawCrosshairIS = false --Draw the crosshair in ironsights?
SWEP.PrintName				= "M40A1"		-- Weapon name (Shown on HUD)
...
SWEP.Type = "American 7.62x51mm Bolt-Action Sniper Rifle"
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_INS2_M40A1.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_INS2_M40A1.2") -- This is the sound of the weapon, when silenced.
...
SWEP.Primary.KickHorizontal = 0.55 -- This is the maximum sideways recoil (no real term)
...
SWEP.CrouchRecoilMultipler = 1
SWEP.IronSightTime = 0.6
SWEP.ProceduralHoslterEnabled = true
SWEP.ProceduralHolsterTime = 0.6
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2/v_m40a1.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2/w_m40a1.mdl" -- Weapon world model path
...
SWEP.RunSightsAng = Vector(20, 30, 0) --Change this, using SWEP Creation Kit preferably
--[[IRONSIGHTS]]--
SWEP.data = {}
...
SWEP.IronSightsPos = Vector(-3.1, -1.5, 0.283)
SWEP.IronSightsAng = Vector(0, 0, 0)

SWEP.IronSightsPos_Kobra = Vector(-3.095, -1.5, 0.45)
SWEP.IronSightsAng_Kobra = Vector(0, 0, 0)

SWEP.IronSightsPos_EOTech =  Vector(-3.1, -1.5, 0.23)
SWEP.IronSightsAng_EOTech = Vector(0, 0, 0)

SWEP.IronSightsPos_RDS = Vector(-3.1, -1.525, 0.15)
SWEP.IronSightsAng_RDS = Vector(0, 0, 0)

SWEP.IronSightsPos_2XRDS = Vector(-3.089, -2.5, 0.153)
SWEP.IronSightsAng_2XRDS = Vector(0, 0.00, 0)
SWEP.Secondary.IronFOV_2XRDS = 65
SWEP.RTScopeFOV_2XRDS        = 30

SWEP.IronSightsPos_C79 = Vector(-3.091, -2.5, -0.015)
SWEP.IronSightsAng_C79 = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_C79 = 65
SWEP.RTScopeFOV_C79        = 50

SWEP.IronSightsPos_PO4X = Vector(-3.03, -4.2, 0.554)
SWEP.IronSightsAng_PO4X = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_PO4X = 65
SWEP.RTScopeFOV_PO4X        = 50

SWEP.IronSightsPos_Mosin = Vector(-3.3709, -0.5, 0.64)
SWEP.IronSightsAng_Mosin = Vector(0, 0, 0)

SWEP.IronSightsPos_MX4 = Vector(-3.117, -2., 0.334)
SWEP.IronSightsAng_MX4 = Vector(0,0,-1.2)
SWEP.Secondary.IronFOV_MX4 = 65

--[[INSPECTION]]--
SWEP.InspectPos = Vector(6.425, -3.225, -2.5)
SWEP.InspectAng = Vector(24.625, 35.924, 15.475)
...
SWEP.WorldModelBoneMods = {
	["ATTACH_Muzzle"] = { scale = Vector(0.9, 0.6, 0.6), pos = Vector(0, -0.2, 0), angle = Angle(0, 0, 0) },
	["ATTACH_ModKit"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, -0.4), angle = Angle(0, 0, 0) },
}
...
SWEP.VElements = {
	...
	["scope_c79"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_elcan_l.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(90, 90, 0), size = Vector(0.63, 0.73, 0.73), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
	["scope_po4x"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_po4x24_l.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(90, 90, 0), size = Vector(0.57, 0.67, 0.67), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
	["scope_mosin"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_mosin.mdl", bone = "A_Optic", rel = "", pos = Vector(0.3, 0, -1.1), angle = Angle(90, 90.6, 0), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
	["scope_mx4"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_m40_l.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(90, 90.7, 0), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_suppressor_sec.mdl", bone = "A_Suppressor", rel = "", pos = Vector(0, -1.4, 28), angle = Angle(90, 90, 0), size = Vector(0.9, 0.63, 0.63), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} , bonemerge = true, active = false },
	["sights_folded"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_standard_m40.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = true, bonemerge = true },
}
...
SWEP.WElements = {
	...
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_sil_ins1.mdl", bone = "ATTACH_Muzzle", rel = "ref", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 0.63, 0.63), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
	["sights_folded"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_flipup_m40.mdl", bone = "ATTACH_ModKit", rel = "ref", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = true, bonemerge = true },
}
...
SWEP.Attachments = {
	...
	[2] = { offset = { 0, 0 }, atts = { "am_match_snpr", "am_magnum", "am_gib_snpr" }, order = 4 },
