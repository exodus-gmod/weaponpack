...
SWEP.Purpose				= "A slow firing, high caliber DMR. Has very high stopping power in exchange for low capacity and fire rate." --Purpose Tooltip
SWEP.Instructions				= "" --Instructions Tooltip
SWEP.Spawnable				= true --Can you, as a normal user, spawn this?
SWEP.AdminSpawnable			= true --Can an adminstrator spawn this?  Does not tie into your admin mod necessarily, unless its coded to allow for GMod's default ranks somewhere in its code.  Evolve and ULX should work, but try to use weapon restriction rather than these.
SWEP.DrawCrosshair			= true		-- Draw the crosshair?
SWEP.DrawCrosshairIS = false --Draw the crosshair in ironsights?
SWEP.PrintName				= "Kel-Tec RFB"		-- Weapon name (Shown on HUD)
...
--Recoil Related
SWEP.Primary.KickUp = 0.456 -- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown = 0 -- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal = 0.168 -- This is the maximum sideways recoil (no real term)
...
SWEP.ViewModelBoneMods = {
	["A_Optic"] = { scale = Vector(0.7, 0.7, 0.7), pos = Vector(0, 0, -0.1), angle = Angle(0, 0, 0) },
	["A_Suppressor"] = { scale = Vector(0.7, 0.7, 0.7), pos = Vector(-0, 2, 0), angle = Angle(0, 0, 0) },
...
SWEP.WorldModelBoneMods = {
	["ATTACH_ModKit"] = { scale = Vector(.75, .75, .75), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["ATTACH_Muzzle"] = { scale = Vector(.75, .75, .75), pos = Vector(0, 2, 0), angle = Angle(0, 0, 0) },
}
...
function SWEP:Think2(...)
    ...
    if self.Owner:KeyPressed(IN_ZOOM) and self:GetIronSights() then 
        if self.CurrentSightState == 1 then 
			...
			self.IronSightsPos = Vector(-2.62, -2.445, 0.709)
			self.IronSightsAng = Vector(0, -0.076, 0)
			self.IronSightsPos_Kobra = Vector(-2.624, -3.5, 0.15)
			self.IronSightsAng_Kobra = Vector(0, 0, 0)
			self.IronSightsPos_EOTech = Vector(-2.624, -3.5, -0.05)
			self.IronSightsAng_EOTech = Vector(0, 0, 0)
			self.IronSightsPos_RDS = Vector(-2.624, -6, -0.1)
			self.IronSightsAng_RDS = Vector(0, 0, 0)
			self.IronSightsPos_2XRDS = Vector(-2.621, -5, -0.115)
			self.IronSightsAng_2XRDS = Vector(0, 0, 0)
			self.IronSightsPos_C79 = Vector(-2.6248, -5, -0.41)
			self.IronSightsAng_C79 = Vector(0, 0, 0)
			self.IronSightsPos_PO4X = Vector(-2.572, -7, 0.24)
			self.IronSightsAng_PO4X = Vector(0, 0, 0)
			self.IronSightsPos_MX4 = Vector(-2.635, -6.2, 0.045)
			self.IronSightsAng_MX4  = Vector(0, 0, -0.85)
