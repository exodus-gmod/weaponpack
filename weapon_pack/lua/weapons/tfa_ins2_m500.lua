...
SWEP.Manufacturer			= "Mossberg" --Gun Manufactrer (e.g. Hoeckler and Koch )
SWEP.Author					= "Edit by Lucho" --Author Tooltip
SWEP.Contact				= "" --Contact Info Tooltip
SWEP.Purpose				= "A high powered 12 Gauge shotgun. Lacks a stock, but makes up for it in firepower." --Purpose Tooltip
...
SWEP.PrintName				= "Mossberg 500"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_INS2.M500.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_INS2.M500.2") -- This is the sound of the weapon, when silenced.
...
SWEP.Primary.RPM_Displayed = 100 -- This is in Rounds Per Minute / RPM
SWEP.Primary.RPM = 100 -- This is in Rounds Per Minute / RPM
SWEP.Primary.BurstDelay = nil -- Delay between bursts, leave nil to autocalculate
SWEP.Primary.DryFireDelay = 0.4
...
SWEP.Primary.KickHorizontal = 0.95 -- This is the maximum sideways recoil (no real term)
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2/c_m500.mdl" --Viewmodel path
SWEP.ViewModelFOV			= 70		-- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip			= false		-- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands = true --Use gmod c_arms system.
SWEP.VMPos = Vector(0, -4, 0) --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2/w_m500.mdl" -- Weapon world model path
...
-- SWEP.IronSightsPos = Vector(-2.615, -2, 1.21)
SWEP.IronSightsPos = Vector(-2.615, -2, 1.1)
SWEP.IronSightsAng = Vector(0.78, 0, 0)

SWEP.IronSightsPos_Kobra = Vector(-2.603, -8, -0.007)
SWEP.IronSightsAng_Kobra = Vector(0, 0, 0)

SWEP.IronSightsPos_EOTech = Vector(-2.603, -8, -0.245)
SWEP.IronSightsAng_EOTech = Vector(0, 0, 0)

SWEP.IronSightsPos_RDS = Vector(-2.603, -8, -0.247)
SWEP.IronSightsAng_RDS = Vector(0, 0, 0)

SWEP.IronSightsPos_2XRDS = Vector(-2.601, -8, -0.25)
SWEP.IronSightsAng_2XRDS = Vector(0, 0, 0)

SWEP.IronSightsPos_C79 = Vector(-2.603, -5.5, -0.667)
SWEP.IronSightsAng_C79 = Vector(0, 0, 0)

SWEP.IronSightsPos_PO4X = Vector(-2.539, -8, 0.086)
...
SWEP.StatusLengthOverride = {
	[ACT_VM_RELOAD_EMPTY] = 96 / 35,
	[ACT_VM_RELOAD] = 20 / 36,
	["foregrip_reload_empty"] = 96 / 35,
	["foregrip_reload"] = 20 / 36,
} --Changes the status delay of a given animation; only used on reloads.  Otherwise, use SequenceLengthOverride or one of the others
SWEP.SequenceLengthOverride = {
	[ACT_SHOTGUN_PUMP] = 14 / 24,
	[ACT_VM_PULLBACK] = 20 / 35,
	[ACT_VM_PULLBACK_LOW] = 12 / 24,
...
SWEP.EventTable = {
	[ACT_SHOTGUN_PUMP] = {
		{ ["time"] = 2 / 24, ["type"] = "lua", ["value"] = function(wep, vm)
			wep:EventShell()
		end, ["client"] = true, ["server"] = true }
	},
	[ACT_VM_PULLBACK] = {
		{ ["time"] = 4 / 35, ["type"] = "lua", ["value"] = function(wep, vm)
			wep:EventShell()
		end, ["client"] = true, ["server"] = true }
	},
	[ACT_VM_RELOAD_EMPTY] = {
...
SWEP.VElements = {
	["rail_sights"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_modkit_05.mdl", bone = "A_Modkit", rel = "", pos = Vector(0, -1.325, 3.5), angle = Angle(90, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },

	["sight_kobra"] = { type = "Model", model = "models/weapons/upblitz/a_optic_kobra_lp.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
	...
	["scope_c79"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_elcan.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
	...
	["foregrip"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_foregrip_ins2.mdl", bone = "A_Foregrip", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 90, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
...
SWEP.Attachments = {
	...
	[8] = { atts = { "ins2_si_kobra", "ins2_si_eotech", "ins2_si_rds", "ins2_si_2xrds" }, order = 1 },
