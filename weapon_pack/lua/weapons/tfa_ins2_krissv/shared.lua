...
SWEP.Purpose				= "A specially designed 9mm SMG built for personal defense purposes. Comes with a 33 round glock magazine." --Purpose Tooltip
...
SWEP.Primary.KickDown = 0.121 -- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal = 0.077 -- This is the maximum sideways recoil (no real term)
...
SWEP.Attachments = {
	...
	[9] = { offset = { 0, 0 }, atts = { "ins2_si_kobra", "ins2_si_eotech", "ins2_si_rds", "ins2_si_2xrds", "ins2_si_c79", "ins2_si_po4x" }, order = 1 },
