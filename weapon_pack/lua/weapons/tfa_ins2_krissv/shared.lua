...
SWEP.Purpose				= "A specially designed .45 SMG built for personal defense purposes. Comes with a 33 round magazine." --Purpose Tooltip
...
SWEP.ViewModelBoneMods = {
	["A_Optic"] = { scale = Vector(0.85, 0.85, 0.85), pos = Vector(0, -1.5, 0), angle = Angle(0, 0, 0) },
...
SWEP.WElements = {
	...
	["laser"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_laser_ins.mdl", bone = "ATTACH_Laser", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
}
...
SWEP.ScopeDistanceMin_2XRDS = 7.25
...
SWEP.ScopeDistanceMin_PO4X = 7.75
...
function SWEP:Think2(...)
    ...
    if self.Owner:KeyPressed(IN_ZOOM) and self:GetIronSights() then 
        if self.CurrentSightState == 1 then 
			...
			self.IronSightsPos = Vector(-3.579, -4.887, 1.44)
			self.IronSightsAng = Vector(0, -0.051, 0)
			self.IronSightsPos_Kobra = Vector(-3.555, -5, 1.125)
			self.IronSightsAng_Kobra = Vector(0, 0, 0)
			self.IronSightsPos_EOTech = Vector(-3.555, -5, 0.92)
			self.IronSightsAng_EOTech = Vector(0, 0, 0)
			self.IronSightsPos_RDS = Vector(-3.555, -7.5, 0.92)
			self.IronSightsAng_RDS = Vector(0, 0, 0)
			self.IronSightsPos_2XRDS = Vector(-3.553, -7.5, 0.92)
			self.IronSightsAng_2XRDS = Vector(0, 0, -0.009)
			self.IronSightsPos_C79 = Vector(-3.556, -5, 0.56)
			self.IronSightsAng_C79 = Vector(0, 0, 0.07)
			self.IronSightsPos_PO4X = Vector(-3.49, -6.5, 1.025)
			self.IronSightsAng_PO4X = Vector(0, 0, 0.07)
